(function(d, w) {
    ...
    ADMITAD.Utf8 = {}, ADMITAD.Utf8.encode = function(e) {
        ...
        for (var r = {
            ...
            }, t = [], o = 0; o < ADMITAD.Invoice.referencesOrder.length; ++o)
            for (var n = ADMITAD.Invoice.referencesOrder[o], i = 1, a = 0; a < n.orderedItem.length; ++a) {
        ...
        var t = 0;
        if (e.length !== r)
            for (var o = r - e.length; o > 0; o--) e.push(""), t += ADMITAD.Tracking.overheadByParam;
        return t
        ...
        for (var n in ADMITAD.Tracking.singleParams)
            if (ADMITAD.Tracking.singleParams.hasOwnProperty(n)) {
