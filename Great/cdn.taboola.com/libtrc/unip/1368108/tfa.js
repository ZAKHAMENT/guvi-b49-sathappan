...
function(e, t) {
    ...
    }, e._tfa.config = new e._tfa.TfaConfig, e._taboola = e._taboola || []), e._tfa.config.addConfig(1368108, {
        "tfa:event-host-map": {
...
function(e, t, n) {
    ...
    var Z = {
        ...
        te = function e(t) {
            r[t.callbackName] = function() {}, t.newScriptElement.parentNode.removeChild(t.newScriptElement), t.newScriptElement = null, delete t.newScriptElement
        },
        ne = function t(n) {
            te(n), n[E] = w, n.isMediaRequest || (e.TRC.trkRequestStatus = !1), F === B.PENDING_USER_ID_SET && (F = B.UNINITIALIZED), n[T] ? r.eventUtils.dispatchEvent(r.sharedEvents.INVALID_TRK_RESPONSE, {
        ...
        ae = function t(r, i, o, a) {
            var s = n.rboxTrcProtocol + "//trc.taboola.com/" + r + "/trc/3/json?" + "tim=" + (new Date).getTime() + "&" + "data=" + encodeURIComponent(JSON.stringify(ce(a))) + "&" + "pubit=" + i,
                c = o.isMediaRequest ? e._tfa.config.safeGet("tfa:trk:tracking-request-timeout", b, r) : y;
            a[E] = _, a[m] = e.setTimeout(oe(a), c), a.newScriptElement = re(s, function() {
                a[T] = !0
            })
        },
        se = function e(t) {
        ...
        ce = function e(t) {
            return r[t.callbackName] = se(t), be(t)
        },
        ue = function e(t) {
            var n = h[t = "" + t];
    ...
    var Se = function e(t) {
        ...
        be = function e(t) {
            var n = ye(t);
            return Ce() && pe(n), t.isMediaRequest && (n = Te(t, n)), n
        },
        Ie = function e(t) {
    ...
    e.TRC = e.TRC || {}, e.TRC.trk = r.trk = e.TRC.trk || {
        init: function t() {
            r.trk.parseCookieBanner(), e.TRC.utm && !W() || (W() || g || (e.TRC._getGlobalRequestId = _e, e.TRC._getItemId = Re, e.TRC._getItemType = Le, g = !0), e.TRC.hasTrk ? W() || r.trk.execute() : e._tfa && !e._tfa.config.hasValidConfig() || (r.hasTrk = !0, J() && (r.eventUtils.safeAddEventListener(r.sharedEvents.PAGE_VIEW, function(t) {
                try {
                    var i = t.detail,
                        o = i.publisherIdType,
                        a = i.accountId,
            ...
            }), W() || r.trk.execute(), n.enableVV && Fe(), W() && e._tfa.config.safeGet("tfa:trk:topics-enabled", !1, n.bakedPublisherId) && this.observeTopics())))
        },
        execute: function t() {
    ...
    }, W() && !e._tfa.config.safeGet("tfa:trk:enabled", !0, n.bakedPublisherId) || r.trk.init()
}(window, document, {
    bakedPublisherId: 1368108,
    bakedPublisherName: 'taboolaaccount-infoguviin',
    tblVersion: "20240804-10-RELEASE",
...
function(e, t) {
    ...
    var u = function r() {
        return this.state = {}, this.getLocalStorageImplementation = function(t, n) {
            ...
            return t.doNotTrack && !this.isAllowedKeyWhenDoNotTrack(n) ? null : this.getLocalStorageImplementation().getValue(this.buildKeyWithPublisher(e, n))
    ...
    t.tfaPageManager = t.tfaPageManager || new u, t.tfaPageManager.TABOOLA_GLOBAL_KEY = n
}(window, window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC']),
function(e, t, n) {
...
function(e, t) {
    ...
    function O(e) {
        (isNaN(T) || T < 0) && (T = 0), a.hasSessionEnded() || (T++, a.persistSpecificMetricsData(m, T), k() || o.sendMetrics("i", e), U())
    }
    ...
    function U() {
        if (clearTimeout(y), b && !d.getIsPageHidden()) {
            var e = p * Math.pow(2, T);
            e !== 1 / 0 && (y = setTimeout(O, e, e))
        }
    }
    ...
    function L() {
        h.subscribeToEvent(x.bind(this)), d.subscribeToEvent(M.bind(this))
    }

    function M() {
        d.getIsPageHidden() ? A() : U()
    }
    ...
    function x(e) {
        ...
        N(), e && b && !d.getIsPageHidden() && t(e) && (b = !1, A(), V(g, v, D, A))
    }
    ...
    function V(e, t, n, r) {
        ...
        function s() {
            i = !1, o({
                ...
                i ? setTimeout(t, s) : b || (b = !0, n(), a())
            }, e)
        }
        b = !1, window.addEventListener("message", function(e) {
            var o = e.data;
            o && "TARP" === o.type && e.source !== window && (b ? o.query ? a() : o.t < I ? (b = !1, i = !0, r(), setTimeout(t, s)) : a() : o.query || (o.t < I ? i = !0 : (b = !0, n(), a())))
        }), s()
    }

    function j() {
        o.initialized || r.config.safeGet("tfa:engagement:is-manager-disabled", !1, 1368108) || (i = r.TUP || {}, o.initialized = !0, o.ESU.init(P), d.init(), h.init(a), L(), o.ESU.getIsLocalStorageAvailable() && (f.init(a), u.init(a, h, d), s.init(a, h), c.init(a, h, t.sharedEvents.PAGE_VIEW), l.init(a, h, f), o.initIntervalTrigger()), V(g, v, D, A))
    }
    o.init = o.init || j, o.onSessionEndTrigger = o.onSessionEndTrigger || P, o.sendMetrics = o.sendMetrics || R, o.initIntervalTrigger = o.initIntervalTrigger || D, o.EVENTS = o.EVENTS || E
}(window, window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC']),
function(e, t) {
    var n = "_tfa",
        r = e[n] = e[n] || [],
    ...
    t.lastExternalReferrer = {
        init: function e() {
            r.config.safeGet("tfa:last-external-referrer:is-disabled", !1, 1368108) || this.extractExternalReferrerIfExistsAndStoreLocally()
        },
...
function(e, t, n) {
    ...
    function u() {
        e._tfa && e._tfa.config && e._tfa.config.safeGet && e._tfa.config.safeGet(r, !1, s) && a.cdt.init()
    }
    e.TRC = e.TRC || {}, e.TRC.cdt = a.cdt = e.TRC.cdt || {
        init: function e() {
            t.addEventListener(i, this.updateTrackingData.bind(this)), this.verifyUpdatesAfterDomLoaded()
        },
        getLinksToUpdate: function e() {
            for (var n = window.location.hostname, r = [], i = t.querySelectorAll('a[href^="http"], a[href^="https"], a[href^="//"]'), o = 0; o < i.length; ++o) try {
                var s = i[o],
                    c = s.href,
                    u, l;
        ...
        updateUrl: function e(t) {
            for (var n = 0; n < o.length; n++) {
                var r;
                if (!(null !== this.getQueryParamFromSearch(t.href, o[n]) || null !== this.getQueryParamFromHash(t.href, o[n]))) {
                    var i = this.getQueryParamFromSearch(window.location.href, o[n]);
                    if (i) {
                        var s = o[n] + "=" + i;
...
function(e, t, n) {
    ...
    function g() {
        ...
        e.initialized && e.domAccountId && setTimeout(function() {
            for (var e = oe().asyncQueue; e.length;) ae(e.shift())
        }, 0)
    }
    ...
    function v() {
        var e = m(),
            t;
        if (e && e.src && (t = e.src.replace(c, "$3"))) return /^\d+$/.test(t) ? parseInt(t, 10) : (ce("Value '" + t + "' is invalid for 'id' param in script source url '" + e.src + "'. Only numeric values are allowed."), INVALID_ACCOUNT_ID)
    }
    ...
    function b() {
        try {
            ...
            ce("Error while trying to add user-id param", e)
        }
    }
    ...
    function I(e) {
        try {
            ...
            ce("Error while trying to addClickIdParam, params=" + JSON.stringify(e), t)
        }
    }
    ...
    function R(e, t) {
        var n = EVENT_PROPERTIES_TO_URL_PARAMS_MAP.url,
            r;
        me(fe(e), t) && (e[n] = e[n] || document.location.href)
    }
    ...
    function U(e, n) {
        ...
        try {
            ...
            ce("Error while trying to send to server event with id '" + e + "' and params '" + JSON.stringify(n) + "'.", t)
        }
    }
    ...
    function D(e) {
        ...
        if (n) {
            if (!t) return ue("No UserId to notify callback"), void delete e[CALLBACK_PARAMETER_NAME];
            if ("function" != typeof n) return ue("Callback function parameter is not a function " + n), void delete e[CALLBACK_PARAMETER_NAME];
            try {
                n({
                    userId: t
                })
            } catch (e) {
                ce("Error calling advertiser callback", e)
            }
    ...
    function N(e, t) {
        y(e), I(e), _(e), z(e), R(e, t), V(e), L(e), K(e, t), x(e, t), $(e, t), M(e)
    }
    ...
    function Y(e, t) {
        if (e === f)
            for (var n in t)
                if (!([EVENT_PROPERTIES_TO_URL_PARAMS_MAP.name, EVENT_PROPERTIES_TO_URL_PARAMS_MAP.timestamp].indexOf(n) >= 0)) return !0;
        return !1
    }
    ...
    function X(e, n) {
        ...
        if (!t.trk.getPublisherRequestId(e)) {
            if (t.trk.isRequestProcessing(e)) return void r.messageDelayer.delayMessage(e, n, {
                ...
                timeoutInMillis: le(e)
            });
            J(n, t.trk.getRequestStatus(e))
        }
        U(e, n)
    }
    ...
    function Z(e, n) {
        ...
        if (n = parseInt(n, 10), !o || !o(r, n)) {
            if (ge(n)) {
                if (ve(n)) return void X(n, r);
                t.trk.getPublisherRequestId(n) || J(r, "wffo")
            } else J(r, "ttd");
            U(n, r)
        }
    }
    ...
    function re(e, n) {
        var r = oe(),
            i = !1;
        return n && (i = ne(e, n), N(e), r.pageViewAccountIds[n] = parseInt(n, 10), t.eventUtils.dispatchEvent(t.sharedEvents.PAGE_VIEW, {
            accountId: n,
    ...
    function ie(e) {
        return e ? e.notify ? s.hasOwnProperty(e.notify) ? e.name ? !(e.hasOwnProperty("id") && !/^\d+$/.test(e.id)) || (se(VALIDATION_ERRORS.INVALID_ID, e, "Value '" + e.id + "' is invalid for 'id' field in command '" + JSON.stringify(e) + "'. Only numeric values are allowed."), !1) : (se(VALIDATION_ERRORS.MISSING_NAME, e, "Mandatory 'name' field is missing in command '" + JSON.stringify(e) + "'."), !1) : (se(VALIDATION_ERRORS.INVALID_NOTIFY, e, "Value '" + e.notify + "' is invalid for 'notify' field in command '" + JSON.stringify(e) + "'."), !1) : (se(VALIDATION_ERRORS.MISSING_NOTIFY, e, "Mandatory 'notify' field is missing in command '" + JSON.stringify(e) + "'."), !1) : (se(VALIDATION_ERRORS.EMPTY_COMMAND, e, "Command is '" + e + "'."), !1)
    }
    ...
    function ae(e) {
        var t, n;
        if (ie(e))
            if (t = oe(), n = e.id || t.domAccountId) {
                if (n !== INVALID_ACCOUNT_ID) try {
                    s[e.notify](e, n)
                } catch (t) {
                    ce("An error occurred while handling command '" + JSON.stringify(e) + "'.", t)
                }
    ...
    function pe(e) {
        return ge(e) && o.config.safeGet("tfa:trk:is-unified-page-view", !1, e)
    }
    ...
    }, TUP_EVENT_HANDLERS_BY_EVENT_NAME = ((p = {})[f] = re, p), TRK_EVENT_TO_ERROR_TYPE_MAP = function() {
        var e = {};
    ...
    }(), PUBLISHER_ID_EXISTS = !isNaN(parseFloat(1368108)), CALLBACK_PARAMETER_NAME = "callback", LAST_EXTERNAL_REFERRER_URL_PARAM = "ler", Se()
}(window, window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC'], "20240804-10-RELEASE"),
function(e, t, n) {
    var r = "_tfa",
        i, o = {
            orderid: "orderid",
    ...
    function S() {
        var t, n, r, i;
        if (r = e._tfa.config.safeGet("tfa:get-publisher-id-from-baker", !1) && p ? 1368108 : w())
            for (t = 0, n = l.length; t < n; t++) y(T(s, {
                $publishreId: r ? r + "/" : "",
                $logType: "action"
            }) + "tim=" + escape(I()) + "&item-url=" + escape(b()) + C(o, l.shift()) + _() + v() + m())
    }

    function E() {
        var t, n, r, i;
        if (r = e._tfa.config.safeGet("tfa:get-publisher-id-from-baker", !1) && p ? 1368108 : w())
            for (t = 0, n = f.length; t < n; t++) y(T(s, {
                $publishreId: r ? r + "/" : "",
                $logType: "mark"
            }) + "tim=" + escape(I()) + "&item-url=" + escape(b()) + C(a, f.shift()) + _() + v() + m())
    }
    ...
    function _() {
        var n = e.location.search,
            ...
            i = "";
        return i = R(n.replace(/^\?/, "").split(/&/)) + (r ? R(r[0].replace(/^\?/, "").split(/&/)) : "")
    }
