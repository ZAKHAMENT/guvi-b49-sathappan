(function() {
    ...
    (function() {
        function Ba() {
            function a() {
                if (!a.Gc) la = a.Gc = m, ma = D, c.a(F, function(a) {
                    a.tc()
                })
            }
            ...
            if (v.addEventListener) "complete" === v.readyState ? a() : v.addEventListener("DOMContentLoaded", a, D);
        ...
        function Ca() {
            x.init = function(a, b, d) {
                if (d) return x[d] || (x[d] = F[d] = S(a,
                    b, d), x[d].la()), x[d];
                d = x;
                if (F.mixpanel) d = F.mixpanel;
                else if (a) d = S(a, b, "mixpanel"), d.la(), F.mixpanel = d;
                x = d;
                1 === ca && (o.mixpanel = x);
                Da()
            }
        ...
        function q(a) {
            ...
            var b = a.persistence;
            if ("cookie" !== b && "localStorage" !== b) n.B("Unknown persistence type " + b + "; falling back to cookie"),
                b = a.persistence = "cookie";
            this.j = "localStorage" === b && c.localStorage.ta() ? c.localStorage : c.cookie;
            this.load();
            this.nc(a);
            this.zd();
            this.save()
        ...
        function C(a, b) {
            ...
            this.qa = this.C.batch_flush_interval_ms;
            this.fa = !this.C.batch_autostart;
            this.Ja = 0;
            this.I = {};
            this.Db = b.Db || D
        }
        ...
        function ua(a, b) {
            if (La(b)) return n.warn('This browser has "Do Not Track" enabled. This will prevent the Mixpanel SDK from sending any data. To ignore the "Do Not Track" browser setting, initialize the Mixpanel instance with the config "ignore_dnt: true"'), m;
            var d = "0" === V(b).get(W(a, b));
            d && n.warn("You are opted out of Mixpanel tracking. This will prevent the Mixpanel SDK from sending any data.");
            return d
        }
        ...
        function ta(a, b, d) {
            !c.Xa(b) || !b.length ? n.error("gdpr." + (a ? "optIn" : "optOut") + " called with an invalid token") : (d = d || {}, V(d).set(W(b, d), a ? 1 : 0, c.Lb(d.xb) ? d.xb : r, !!d.yb, !!d.ad, !!d.Dc, d.wb), d.o && a && d.o(d.sd || "$opt_in", d.td, {
                send_immediately: m
            }))
        }
        ...
        function ia(a, b) {
            return function() {
                ...
                try {
                    ...
                    n.error("Unexpected error when checking tracking opt-out status: " + e)
                }
        ...
        c.bind = function(a, b) {
            ...
            return f = function() {
                if (!(this instanceof f)) return a.apply(b, d.concat(L.call(arguments)));
                var c = {};
                c.prototype =
                    a.prototype;
                var g = new c;
        ...
        c.Q = function(a) {
            return !a ? [] : a.Q ? a.Q() : c.isArray(a) || c.Oc(a) ? L.call(a) : c.Bd(a)
        };
                    ...
                    switch (typeof s) {
                        ...
                        case "object":
                            ...
                            if ("[object Array]" === Q.apply(s)) {
                                ...
                                return i = 0 === p.length ? "[]" : g ? "[\n" + g + p.join(",\n" + g) + "\n" + e + "]" : "[" + p.join(",") + "]"
                            }
                            for (t in s) X.call(s, t) && (i = b(t, s)) && p.push(d(t) + (g ? ": " : ":") + i);
                            return i = 0 === p.length ? "{}" : g ? "{" + p.join(",") + "" + e + "}" : "{" + p.join(",") + "}"
                    }
                }
                        ...
                        a: {
                            ...
                            if ("{" === i) {
                                ...
                                for (; i;) {
                                    ...
                                    b();
                                    h(":");
                                    Object.hasOwnProperty.call(k, t) && g('Duplicate key "' + t + '"');
                                    k[t] = s();
                                    b();
                                    if ("}" === i) {
                                        h("}");
        ...
        c.Ad = function(a) {
            ...
            for (g = 0; g < h; g++) {
                ...
                i !== r && (c > d && (b += a.substring(d, c)), b += i, d = c = g + 1)
            }
        ...
        c.jb = function() {
            function a() {
                ...
                var b, c, g = [],
                    e = 0;
                for (b = 0; b < z.length; b++) c = z.charCodeAt(b), g.unshift(c &
                    255), 4 <= g.length && (e = a(e, g), g = []);
                0 < g.length && (e = a(e, g));
        ...
        var za = "ahrefsbot,ahrefssiteaudit,baiduspider,bingbot,bingpreview,chrome-lighthouse,facebookexternal,petalbot,pinterest,screaming frog,yahoo! slurp,yandexbot,adsbot-google,apis-google,duplexweb-google,feedfetcher-google,google favicon,google web preview,google-read-aloud,googlebot,googleweblight,mediapartners-google,storebot-google".split(",");
        c.Kb = function(a) {
            var b, a = a.toLowerCase();
            for (b = 0; b < za.length; b++)
                if (-1 !== a.indexOf(za[b])) return m;
            return D
        };
        c.qc = function(a) {
            var b, d, f, h = [];
        ...
        c.Qa = function(a, b) {
            ...
            try {
                ...
                n.error("Skipping decoding for malformed query param: " +
                    c)
            }
            return c.replace(/\+/g, " ")
        };
        c.cookie = {
            ...
            Gd: function(a, b, c, f, h, g, e) {
                var i = "",
                    k = "",
                    p = "";
                e ? i = "; domain=" + e : f && (i = (i = sa(v.location.hostname)) ? "; domain=." + i : "");
        ...
        c.localStorage = {
            ta: function(a) {
                (a = U(r, a)) || n.error("localStorage unsupported; falling back to cookie store");
                return a
            },
            error: function(a) {
        ...
        c.Vb = function() {
            ...
            return function(b, c, h, g, e) {
                b ? b.addEventListener && !g ? b.addEventListener(c, h, !!e) : (c = "on" + c, b[c] = a(b, h, b[c])) : n.error("No valid element provided to register_event")
            }
        }();
        var Oa = /^(\w*)\[(\w+)([=~\|\^\$\*]?)=?"?([^\]"]*)"?\]$/;
        c.Fc = function() {
            ...
            function b(b) {
                ...
                for (i = 0; i < b.length; i++)
                    ...
                    for (k = e = 0; k < w.length; k++) {
                        s = "*" == d ? w[k].all ? w[k].all : w[k].getElementsByTagName("*") : w[k].getElementsByTagName(d);
                        for (p = 0; p < s.length; p++) g[e++] = s[p]
                    }
                    w = [];
                    for (k = d = 0; k < g.length; k++) g[k].className && c.Xa(g[k].className) && a(g[k], B) && (w[d++] = g[k])
                    ...
                    switch (B) {
                        ...
                        case "$":
                            B = function(a) {
                                return a.getAttribute(j).lastIndexOf(o) == a.getAttribute(j).length - o.length
                            };
                            break;
                        case "*":
                            B = function(a) {
        ...
        var Pa = ["utm_source", "utm_medium", "utm_campaign", "utm_content", "utm_term"],
            Qa = "dclid,fbclid,gclid,ko_click_id,li_fat_id,msclkid,ttclid,twclid,wbraid".split(",");
        c.info = {
            Z: function(a) {
                var b = "",
                    d = {};
            ...
            $c: function(a) {
                var b = c.info.Zc(a),
                    d = {};
                if (b !== r) d.$search_engine = b, a = c.Qa(a, "yahoo" != b ? "q" : "p"), a.length && (d.mp_keyword = a);
                return d
            },
            na: function(a, b, d) {
                return d || c.i(a, " OPR/") ? c.i(a, "Mini") ? "Opera Mini" : "Opera" : /(BlackBerry|PlayBook|BB10)/i.test(a) ? "BlackBerry" : c.i(a, "IEMobile") || c.i(a, "WPDesktop") ? "Internet Explorer Mobile" : c.i(a, "SamsungBrowser/") ? "Samsung Internet" : c.i(a, "Edge") || c.i(a, "Edg/") ? "Microsoft Edge" : c.i(a, "FBIOS") ? "Facebook Mobile" : c.i(a, "Chrome") ? "Chrome" : c.i(a, "CriOS") ? "Chrome iOS" : c.i(a, "UCWEB") || c.i(a, "UCBrowser") ? "UC Browser" : c.i(a, "FxiOS") ? "Firefox iOS" : c.i(b || "", "Apple") ? c.i(a, "Mobile") ? "Mobile Safari" : "Safari" :
                    c.i(a, "Android") ? "Android Mobile" : c.i(a, "Konqueror") ? "Konqueror" : c.i(a, "Firefox") ? "Firefox" : c.i(a, "MSIE") || c.i(a, "Trident/") ? "Internet Explorer" : c.i(a, "Gecko") ? "Mozilla" : ""
            },
            Ia: function(a, b, d) {
                b = {
            ...
            Pb: function() {
                return /Windows/i.test(z) ? /Phone/.test(z) || /WPDesktop/.test(z) ? "Windows Phone" : "Windows" :
                    /(iPhone|iPad|iPod)/.test(z) ? "iOS" : /Android/.test(z) ? "Android" : /(BlackBerry|PlayBook|BB10)/i.test(z) ? "BlackBerry" : /Mac/i.test(z) ? "Mac OS X" : /Linux/.test(z) ? "Linux" : /CrOS/.test(z) ? "Chrome OS" : ""
            },
            Cb: function(a) {
            ...
            ba: function(a) {
                "object" !== typeof a && (a = {});
                return c.extend(c.ga({
                    $os: c.info.Pb(),
                    $browser: c.info.na(z, I.vendor, Y),
                    $referrer: v.referrer,
        ...
        c.JSONDecode = c.T;
        c.isBlockedUA = c.Kb;
        c.isEmptyObject = c.sa;
        c.info =
            c.info;
        c.info.device = c.info.Cb;
        c.info.browser = c.info.na;
        ...
        E.prototype.o = function(a, b, d, f) {
            var h = this,
                g = c.Fc(a);
            if (0 === g.length) n.error("The DOM query (" + a + ") returned 0 elements");
        ...
        M.prototype.pa = function(a, b) {
            var c = M.pd.pa.apply(this, arguments);
        ...
        M.prototype.Ga = function(a,
            b) {
            b.Nb || setTimeout(function() {
        ...
        ra.prototype.ib = function(a, b, c) {
            function f() {
                ...
                try {
                    ...
                    j.removeItem(n), j.getItem(q) === k && j.removeItem(q), j.getItem(o) === k && j.removeItem(o)
                }
            }
            ...
            function h() {
                j.setItem(o, k);
                e(g, function() {
                    j.getItem(o) === k ? f() : i(function() {
                        j.getItem(q) !== k ? h() : e(function() {
                                return !j.getItem(n)
                            },
                            f)
                    })
            ...
            function i(a) {
                (new Date).getTime() - p > B ? (Ra.error("Timeout waiting for mutex on " + s + "; clearing lock. [" + k + "]"), j.removeItem(n), j.removeItem(q), h()) : setTimeout(function() {
                    try {
                        a()
                    } catch (c) {
                        b && b(c)
        ...
        G.prototype.Na = function(a, b, d) {
            ...
            this.z ? this.Ya.ib(c.bind(function() {
                var b;
                try {
                    var c = this.ea();
                    c.push(f);
                ...
                this.h("Error acquiring storage lock",
                    a);
                d && d(D)
            }, this), this.va) : (this.D.push(f), d && d(m))
        };
            ...
            if (this.z && b.length < a) {
                ...
                if (d.length) {
                    ...
                    for (var h = 0; h < d.length; h++) {
                        var g = d[h];
                        if ((new Date).getTime() > g.flushAfter && !f[g.id] && (g.Uc = m, b.push(g), b.length >= a)) break
                    }
                }
            }
            return b
            ...
            if (this.z) {
                var f = c.bind(function() {
                    ...
                    try {
                        ...
                        if (b = this.ab(c))
                            for (var c =
                                    this.ea(), f = 0; f < c.length; f++) {
                                var e = c[f];
                                if (e.id && d[e.id]) return this.h("Item not removed from storage"), D
                            }
                    } catch (k) {
        ...
        G.prototype.ea = function() {
            var a;
            try {
                if (a = this.j.getItem(this.P)) a = aa(a), c.isArray(a) || (this.h("Invalid storage entry:", a), a = r)
            } catch (b) {
        ...
        C.prototype.$b = function(a) {
            this.qa = a;
            if (!this.fa) this.eb = setTimeout(c.bind(function() {
                this.fa ||
                    this.flush()
            }, this), this.qa)
        };
        C.prototype.flush = function(a) {
            try {
                if (this.Xb) R.log("Flush: Request already in progress");
                    ...
                    c.a(h, function(a) {
                        var b = a.payload;
                        this.ma && !a.Uc && (b = this.ma(b));
                        if (b) {
                            b.event && b.properties && (b.properties = c.extend({}, b.properties, {
                                mp_sent_by_lib_version: "2.55.0"
                            }));
                            var d = m,
                                f = a.id;
                            if (f) {
                                if (5 < (this.I[f] || 0)) this.h("[dupe] item ID sent too many times, not sending", {
                                    item: a,
                                    G: h.length,
                                    rd: this.I[f]
                                }), d = D
                    ...
                    if (1 > t.length) this.N();
                        ...
                        var k = c.bind(function(k) {
                                ...
                                try {
                                    ...
                                    if (a.lc) this.ca.yd(i);
                                    else if (c.e(k) && "timeout" === k.error && (new Date).getTime() - d >= b) this.h("Network timeout; retrying"), this.flush();
                                    else if (c.e(k) && (500 <= k.Sa || 429 === k.Sa || "timeout" === k.error)) {
                                        var j = 2 * this.qa;
                                        ...
                                        if (1 < h.length) {
                                            ...
                                            this.N()
                                        } else this.h("Single-event request too large; dropping", h), this.Yb(), t = m;
                                    else t = m;
                                    t && (this.ca.Wc(c.map(h, function(a) {
                                        return a.id
                                    }), c.bind(function(a) {
                                        a ? (this.Ja = 0, this.Db && !e ? this.N() : this.flush()) : (this.h("Failed to remove items from queue"), 5 < ++this.Ja ? (this.h("Too many queue failures; disabling batching system."),
                                            this.md()) : this.N())
                                    }, this)), c.a(h, c.bind(function(a) {
                                        var b = a.id;
                                        b ? (this.I[b] = this.I[b] || 0, this.I[b]++, 5 < this.I[b] && this.h("[dupe] item ID sent too many times", {
                                            item: a,
                                            G: h.length,
                                            rd: this.I[b]
        ...
        u.prototype.ha = N(function(a, b, d) {
            c.e(a) && (d = b);
        ...
        u.prototype.union = u.prototype.ha;
        ...
        j.prototype.Ib = H(function(a, b, d) {
            ...
            c.e(a) ? (c.a(a,
                function(a, b) {
                    this.A(b) || (isNaN(parseFloat(a)) ? n.error("Invalid increment value passed to mixpanel.people.increment - must be a number") : e[b] = a)
                }, this), d = b) : (c.g(b) && (b = 1), e[a] = b);
            f.$add = e;
            return this.k(f, d)
        });
        ...
        j.prototype.ha = H(function(a, b, d) {
            c.e(a) && (d = b);
            return this.k(this.kc(a, b), d)
        });
        j.prototype.ud = H(function(a, b, d) {
            if (!c.Lb(a) &&
                (a = parseFloat(a), isNaN(a))) {
                n.error("Invalid value passed to mixpanel.people.track_charge - must be a number");
                return
            }
        ...
        j.prototype.Bb = function() {
            if (this.Da()) return this.k({
                $delete: this.d.M()
            });
            n.error("mixpanel.people.delete_user() requires you to call identify() first")
        };
        ...
        j.prototype.k = function(a, b) {
            ...
            d = c.Ma(a);
            return !this.Da() ? (this.uc(a), c.g(b) || (this.p("verbose") ? b({
                status: -1,
                error: r
            }) : b(-1)), c.truncate(d, 255)) : this.d.Fa({
                type: "people",
                data: d,
        ...
        j.prototype.W = function(a, b, d, f) {
            var e = this,
                ...
                j = g;
            !c.g(g) && c.e(g) && !c.sa(g) &&
                (e.d.persistence.v(a, g), e.d.persistence.save(), f && (j = f(g)), b.call(e, j, function(b, f) {
        ...
        j.prototype.vc = function(a, b, d, f, e, g, j) {
            ...
            this.W("$union", this.ha, e);
            a = this.d.persistence.aa("$append");
            if (!c.g(a) && c.isArray(a) && a.length)
                for (var k, b = function(a, b) {
                            0 === a && i.d.persistence.q("$append", k);
                            c.g(d) || d(a, b)
                        }, f = a.length -
                        1; 0 <= f; f--) a = this.d.persistence.aa("$append"), k = a.pop(), i.d.persistence.save(), c.sa(k) || i.append(k, b);
            a = this.d.persistence.aa("$remove");
            if (!c.g(a) && c.isArray(a) && a.length)
                for (var p, b = function(a, b) {
                        0 === a && i.d.persistence.q("$remove", p);
                        c.g(j) || j(a, b)
                    }, f = a.length - 1; 0 <= f; f--) a = this.d.persistence.aa("$remove"), p = a.pop(), i.d.persistence.save(), c.sa(p) || i.remove(p, b)
        };
        ...
        j.prototype.union = j.prototype.ha;
        ...
        var Sa = "__mps,__mpso,__mpus,__mpa,__mpap,__mpr,__mpu,$people_distinct_id,__alias,__timers".split(",");
        q.prototype.ba =
            function() {
                var a = {};
                this.load();
        ...
        q.prototype.zd = function() {
            var a;
            this.j === c.localStorage ? (a = c.cookie.parse(this.name), c.cookie.remove(this.name), c.cookie.remove(this.name, m), a && this.w(a)) : this.j === c.cookie && (a = c.localStorage.parse(this.name), c.localStorage.remove(this.name), a && this.w(a))
        };
        q.prototype.save = function() {
            this.disabled ||
                this.j.set(this.name, c.ia(this.props), this.Pa, this.Ka, this.ac, this.zb, this.oa)
        };
        ...
        q.prototype.remove = function() {
            this.j.remove(this.name, D, this.oa);
            this.j.remove(this.name, m, this.oa)
        };
        ...
        q.prototype.w = function(a, b, d) {
            return c.e(a) ? ("undefined" === typeof b && (b = "None"), this.Pa = "undefined" === typeof d ? this.Ab : d, this.load(), c.a(a, function(a, c) {
                if (!this.props.hasOwnProperty(c) || this.props[c] ===
                    b) this.props[c] = a
            }, this), this.save(), m) : D
        };
        q.prototype.m = function(a, b) {
            return c.e(a) ? (this.Pa = "undefined" === typeof b ? this.Ab : b, this.load(), c.extend(this.props, a), this.save(), m) : D
        };
        ...
        q.prototype.ed = function(a) {
            if (a !== this.oa) this.remove(), this.oa = a, this.save()
        };
        ...
        q.prototype.q = function(a, b) {
            var d = this.ka(a),
                ...
                p = this.F("$remove", []),
                o = this.F("$append", []);
            "__mps" === d ? (c.extend(e, f), this.v("$add", f), this.v("$union", f), this.v("$unset", f)) : "__mpso" === d ? (c.a(f, function(a,
                b) {
                b in g || (g[b] = a)
            ...
            }), this.v("$unset", f)) : "__mpr" === d ? (p.push(f), this.v("$append", f)) : "__mpap" === d && (o.push(f), this.v("$unset", f));
            n.log("MIXPANEL PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):");
            n.log(b);
            this.save()
        };
        q.prototype.v = function(a, b) {
            var d = this.props[this.ka(a)];
        ...
        q.prototype.Xc = function(a) {
            var b = (this.ua("__timers") || {})[a];
            c.g(b) || (delete this.props.__timers[a], this.save());
            return b
        };
        var ca, x, O = o.XMLHttpRequest && "withCredentials" in new XMLHttpRequest,
            ma = !O && -1 === z.indexOf("MSIE") && -1 === z.indexOf("Mozilla"),
            ba = r;
        I.sendBeacon && (ba = function() {
            return I.sendBeacon.apply(I,
                arguments)
        });
        var A = {
                track: "track/",
            ...
            Aa = {
                ...
                batch_autostart: m,
                hooks: {},
                record_block_class: /^(mp-block|fs-exclude|amp-block|rr-block|ph-no-capture)$/,
        ...
        e.prototype.Va = function(a, b, d) {
            ...
            else return a = S(a, b, d), x[d] = a, a.la(), a
        };
        e.prototype.Y = function(a, b, d) {
            ...
            this.config = {};
            var f = {};
            "api_payload_format" in b || (b.api_host || Aa.api_host).match(/\.mixpanel\.com/) && (f.api_payload_format = "json");
            this.cc(c.extend({}, Aa, f, b, {
                name: d,
                token: a,
            ...
            if (this.U = this.c("batch_requests"))
                if (!c.localStorage.ta(m) || !O) this.U = D,
                    n.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support"), c.a(this.Eb(), function(a) {
                        n.log("Clearing batch queue " + a.da);
                        c.localStorage.remove(a.da)
                    });
                else if (this.Nc(), ba && o.addEventListener) {
                var e = c.bind(function() {
                    this.u.L.fa || this.u.L.flush({
                        lc: m
                    })
                }, this);
            ...
            0 < this.c("record_sessions_percent") && 100 * Math.random() <= this.c("record_sessions_percent") && this.gc()
        };
        ...
        e.prototype.od =
            function() {
                this.J ? this.J.stopRecording() : n.B("Session recorder module not loaded")
            };
        ...
        e.prototype.rb = function() {
            ...
            this.c("store_google") && !this.c("stop_utm_persistence") &&
                this.m(c.info.Z());
            this.c("save_referrer") && this.persistence.hb(v.referrer)
        };
        e.prototype.tc = function() {
            c.a(this.ya, function(a) {
                this.Ea.apply(this, a)
            }, this);
            this.$() || c.a(this.za, function(a) {
                this.k.apply(this, a)
            }, this);
            delete this.ya;
            delete this.za
        ...
        e.prototype.xc = function(a) {
            var b = "";
            this.fb() && (b = c.info.La());
            if (c.Ua(["full-url", "url-with-path-and-query-string", "url-with-path"], a)) {
                ...
                if ("function" === typeof d) o.history.pushState = function(a, b, c) {
                    d.call(o.history, a, b, c);
                    o.dispatchEvent(new Event("mp_locationchange"))
                };
                var f = o.history.replaceState;
                if ("function" === typeof f) o.history.replaceState = function(a,
                    b, c) {
                ...
                o.addEventListener("mp_locationchange", function() {
                    var d = c.info.La(),
                        f = D;
                    "full-url" === a ? f = d !== b : "url-with-path-and-query-string" === a ? f = d.split("#")[0] !== b.split("#")[0] : "url-with-path" === a && (f = d.split("#")[0].split("?")[0] !== b.split("#")[0].split("?")[0]);
                    f && this.fb() && (b = d)
                }.bind(this))
            }
        };
        ...
        e.prototype.k = function(a, b, d, f) {
            ...
            var a = a + ("?" + c.qc(b)),
                p = this;
            if ("img" in b) j = v.createElement("img"), j.src = a, v.body.appendChild(j);
            else if (i) {
                try {
                    e = ba(a, j)
                } catch (o) {
                ...
                n.onreadystatechange = function() {
                    if (4 === n.readyState)
                        ...
                        } else a = n.timeout && !n.status && (new Date).getTime() - x >= n.timeout ? "timeout" : "Bad HTTP status: " + n.status + " " + n.statusText, p.l(a), f && (k ? f({
                            status: 0,
                            Sa: n.status,
                            error: a,
                ...
                p.l(y), e = D
            } else j = v.createElement("script"), j.type = "text/javascript", j.async = m, j.defer = m, j.src = a, u = v.getElementsByTagName("script")[0], u.parentNode.insertBefore(j, u);
            return e
        };
        e.prototype.Aa = function(a) {
            ...
            var d, e = [],
                ...
                g = [];
            c.a(a, function(a) {
                a && (d = a[0], c.isArray(d) ? g.push(a) : "function" === typeof a ? a.call(this) :
                    c.isArray(a) && "alias" === d ? e.push(a) : c.isArray(a) && -1 !== d.indexOf("track") && "function" === typeof this[d] ? g.push(a) : h.push(a))
            }, this);
            b(e, this);
            b(h, this);
            b(g, this)
        ...
        e.prototype.bb = function() {
            this.rc = m;
            if (this.sb()) this.U = m, c.a(this.u, function(a) {
                a.start()
            })
        };
        ...
        e.prototype.disable = function(a) {
            "undefined" === typeof a ? this.V.Ec = m : this.xa = this.xa.concat(a)
        };
        ...
        e.prototype.Fa = function(a, b) {
            var d = c.truncate(a.data, 255),
                ...
                k = c.bind(function() {
                    ...
                    return d ? (n.log("MIXPANEL REQUEST:"), n.log(d), this.k(e, this.mb(d), j, this.ob(b, d))) : r
                }, this);
            this.U &&
                !g ? h.Na(d, function(a) {
                    a ? b(1, d) : k()
        ...
        e.prototype.o = K(function(a, b, d, e) {
            ...
            if (c.g(a)) this.l("No event name provided to mixpanel.track");
                ...
                b = c.extend({}, c.info.ba({
                    mp_loader: this.c("mp_loader")
                }), g, this.persistence.ba(), this.R, this.Fb(), b);
        ...
        e.prototype.yc =
            K(function(a, b, c) {
                var e = this.s(a),
                    h = {};
                e === l ? (h[a] = [b], this.m(h)) : -1 === e.indexOf(b) && (e.push(b), h[a] = e, this.m(h));
                return this.people.ha(a, b, c)
            });
        ...
        e.prototype.Kc = function(a, b) {
            var c = this.sc(a, b),
                e = this.lb[c];
            if (e === l || e.Ca !== a || e.Ba !== b) e = new u, e.Y(this, a, b), this.lb[c] = e;
            return e
        };
        ...
        e.prototype.qd = function(a) {
            c.g(a) ? this.l("No event name provided to mixpanel.time_event") :
        ...
        e.prototype.Ta = function(a, b, c, e, h, g, j, i) {
            ...
            a !== k && a !== this.s("__alias") && (this.S("__alias"), this.m({
                distinct_id: a
            }));
            this.V.Gb = m;
        ...
        e.prototype.zc = function(a, b) {
            ...
            var d = this;
            c.g(b) && (b = this.M());
            if (a !== b) return this.pb("__alias", a), this.o("$create_alias", {
                alias: a,
                distinct_id: b
            }, {
                fc: m
        ...
        e.prototype.cc = function(a) {
            if (c.e(a)) c.extend(this.config, a), a.batch_size && c.a(this.u, function(a) {
                a.Yb()
            }), this.c("persistence_name") || (this.config.persistence_name = this.config.cookie_name), this.c("disable_persistence") || (this.config.disable_persistence = this.config.disable_cookie), this.persistence && this.persistence.nc(this.config), J = J || this.c("debug")
        };
        ...
        e.prototype.qb = function(a) {
            var b = (this.config.hooks[a] ||
                Fa).apply(this, L.call(arguments, 1));
            "undefined" === typeof b && (this.l(a + " hook did not return a value"), b = r);
            return b
        };
        e.prototype.s = function(a) {
            return this.persistence.ua([a])
        };
        ...
        e.prototype.wc = function() {
            "localStorage" === this.c("opt_out_tracking_persistence_type") && c.localStorage.ta() && (!this.ra() && this.ra({
            ...
            else if (!this.ra() && (this.c("opt_out_tracking_by_default") || c.cookie.get("mp_optout"))) c.cookie.remove("mp_optout"), this.Za({
        ...
        e.prototype.ja = function(a) {
            ...
            !this.c("disable_persistence") && this.persistence.disabled !== a && this.persistence.dc(a);
        ...
        e.prototype.X = function(a, b) {
            ...
            c.localStorage.ta() || (b.persistence_type = "cookie");
        ...
        e.prototype.Za = function(a) {
            a = c.extend({
                ...
                a);
            a.delete_user && this.people && this.people.Da() && (this.people.Bb(), this.people.tb());
            this.X(Ja, a);
            this.ja(a)
        };
        ...
        e.prototype.has_opted_in_tracking = e.prototype.ra;
