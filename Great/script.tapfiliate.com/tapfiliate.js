! function() {
    var d = window,
        v = window.TapfiliateObject || "tap",
        r = d[v] && d[v].q || [];
    if (!d[v] || !d[v].loaded) {
        d[v] = function(t, n, e, o, i, r) {
            var a = d[v][t];
            if ("function" != typeof a) throw 'Function "' + t + '" not supported';
            a(n, e, o, i, r)
        }, d[v].q = r, d[v].loaded = !0, d[v].baseUrl = "https://frstre.com", d[v].baseUrlDepr = "https://tapi.tapfiliate.com";
        var n, h;
        d[v].Tracking = d[v].Tracking || {}, d[v].options = d[v].options || {};
        var m = {},
            a = !1,
            s = function(t) {
                var n, e, o, i, r;
        ...
        c.supported = function() {
            ...
            n.setAttribute("src", this.options.url + "/?" + this.options.beaconVersion), n.style.width = "1px", n.style.height = "1px", n.style.display = "none", p(window, "message", this);
            var e = this;
            p(n, "load", function() {
        ...
        }, d[v].Create = d[v].Create || {}, d[v].Create.calls = d[v].Create.calls || [], d[v].Click = d[v].Click || {}, d[v].Click.q = d[v].Click.q || [], d[v].Click.calls = d[v].Click.calls || [], d[v].Click.track = function(t, n, e, o) {
            if (window.self === window.top) {
                var i, r, a, c, s;
                if (null === (e = e || {}).referral_code_param && void 0 === e.referral_code || (i = e.referral_code, r = e.referral_code_param, s = r, a = (c = i) || 0 === c ? c : (s = s || "ref", y()[s])), d[v].Click.calls.push(e), !(t && n || a)) return q("No tracking parameters", e, o);
                var l = y(),
                    u = null;
                for (var p in l) "tm_" === p.slice(0, 3) && ((u = u || {})[p.slice(3, p.length)] = l[p]);
                var f = {
                    data: {
                        acc: h,
                        aid: t,
                        ...
                        int: m.integration || null
                    }
                };
                a && (f.data.refc = a), d[v].Click.q.push(f), g()
            }
        }, d[v].Click.flushQueue = function() {
            d[v].Click.q.reverse();
            for (var t = d[v].Click.q.length - 1; 0 <= t; t--) {
                var i = d[v].Click.q[t].data,
                    n = w();
                if (i.aid && i.sid || i.refc) {
                    ...
                    n && l.hasMethod("3pCookie") && (e.vids = n), k(d[v].baseUrl + "/event/", e, null, function(t, n) {
                        var e = t.response || t.responseText;
                        if (n && e) {
                            var o = JSON.parse(e);
                            if (o.vid) return l.write("tap_vid", o.vid, i.options), b([o.vid]), void("function" == typeof i.callback && (1 == i.options.always_callback ? i.callback(null, o) : i.callback(o)))
                        }
                        return q("Tracking request failed", i.options, i.callback)
                    })
                }
                d[v].Click.q.splice(t, 1)
            }
        }, d[v].Conversion = d[v].Conversion || {}, d[v].Conversion.q = d[v].Conversion.q || [], d[v].Conversion.calls = d[v].Conversion.calls || [], d[v].Conversion.flushQueue = function() {
            d[v].Conversion.q.reverse();
            for (var t = d[v].Conversion.q.length - 1; 0 <= t; t--) {
                var o = d[v].Conversion.q[t].data,
                    n = d[v].Conversion.q[t].type,
                    e = void 0 !== d[v].Conversion.q[t].vid ? d[v].Conversion.q[t].vid : w();
                ...
                var i, r = d[v].baseUrlDepr + "/conversions/";
                if ("single" == n) i = {
                    acc: o.acc,
                    vid: e,
                    tid: o.tid,
                ...
                }), e && e.length && d[v].Conversion.q.splice(t, 1)
            }
        }, d[v].Customer = d[v].Customer || {}, d[v].Customer.q = d[v].Customer.q || [], d[v].Customer.calls = d[v].Customer.calls || [], d[v].Customer.flushQueue = function() {
            d[v].Customer.q.reverse();
            for (var t = d[v].Customer.q.length - 1; 0 <= t; t--) {
                var o = d[v].Customer.q[t].data,
                    n = void 0 !== d[v].Customer.q[t].vid ? d[v].Customer.q[t].vid : w();
                if (!(o.acc && n || o.options.coupons && o.options.coupons.length)) return q("Non-tracked visitor", o.options, o.callback);
                k(d[v].baseUrlDepr + "/customers/", {
                    acc: o.acc,
                    vid: n,
                    tid: o.tid,
                    options: o.options,
                    ...
                    "function" == typeof o.callback && (1 == o.options.always_callback ? o.callback(null, e) : o.callback(e, "success"))
                }), n && n.length && d[v].Customer.q.splice(t, 1)
            }
        }, d[v].create = function(t, n, e) {
            var o;
            h = t, m = function() {
                for (var t = {}, n = 0; n < arguments.length; n += 1)
                    for (var e = arguments[n], o = Object.keys(e), i = 0; i < o.length; i += 1) t[o[i]] = e[o[i]];
                return t
            }(m, n || {}), o = m, l.hasMethod("1pcookie") || l.addMethod(i), l.hasMethod("localStorage") || l.addMethod(c), o.include_methods && -1 < o.include_methods.indexOf("3p") && !l.hasMethod("3pCookie") && l.addMethod(new _("3pCookie", {
                url: "https://b.frstre.com",
                beaconVersion: "v1.4"
            })), l.init(), l.read("tap_vid", {}, function(t, n) {
                b(n), g(), "function" == typeof e && e()
            }), d[v].Create.calls.push({
                accountId: t,
                options: n
            })
        }, d[v].detect = function(t, n) {
            t = t || {}, this.urlParams = y();
            var e = this.urlParams[t.asset_param || "tap_a"],
                o = this.urlParams[t.source_param || "tap_s"];
            d[v].Click.track(e, o, t, n)
        }, d[v].click = function(t, n, e) {
            var o = t || {};
            n = n || {};
            var i = o.tap_a || o.asset_id,
                r = o.tap_s || o.source_id;
            void 0 !== o.referral_code && (n.referral_code = o.referral_code), d[v].Click.track(i, r, n, e)
        }, d[v].conversion = function(t, n, e, o, i) {
            if (window.self === window.top) {
                var r = {
                    type: "single",
                    data: {
                ...
                d[v].Conversion.q.push(r), g(), d[v].Conversion.calls.push({
                    type: "single",
                    tid: t,
                    tam: n,
                    options: e,
        ...
        var o = function(t, n, e, o) {
            if (window.self === window.top) {
                ...
                d[v].Customer.q.push(i), g(), d[v].Customer.calls.push({
                    tid: t,
                    options: n
                })
            }
        };
        d[v].customer = function(t, n, e) {
            o(t, n, e, "customer")
        }, d[v].trial = function(t, n, e) {
            o(t, n, e, "trial")
        }, d[v].lead = function(t, n, e) {
            o(t, n, e, "lead")
        }, d[v].transactionMulti = function(t, n, e, o) {
            d[v].conversionMulti(t, n, e, o)
        }, d[v].conversionMulti = function(t, n, e, o) {
            var i = {
                type: "multi",
                data: {
                    acc: h,
            ...
            d[v].Conversion.q.push(i), g(), d[v].Conversion.calls.push({
                type: "multi",
                tid: t,
                options: n,
                com: e
            })
        }, d[v].getTrackingId = function(o, i) {
            if (l.hasMethod("3pCookie")) throw "getTrackingId not supported with 3rd party cookies enabled";
            o = o || {};
            var r = 0;
            ! function e() {
                setTimeout(function() {
        ...
        }, d[v].detectClick = function(t) {
            d[v].detect({
                referral_code_param: null
            }, t)
        }, d[v].transaction = function(t, n, e, o, i) {
            d[v].conversion(t, n, e, o, i)
        };
        try {
            a = y().tap_test || i.read("tap_debug").length
        } catch (t) {
            a = !1
        }
        var u = function() {
            i.write("tap_debug", "true", {}, function() {});
        ...
        ! function() {
            if (a) {
                ...
                function n() {
                    !t && -1 < ["interactive", "complete"].indexOf(document.readyState) && (t = !0, u())
                }
                return document.addEventListener("readystatechange", n), window.addEventListener("load", n), n()
            }
            var e;
            r.reverse();
            for (var o = r.length - 1; 0 <= o; o--) {
                var i = r[o][0];
                "create" === i && e || (d[v].apply(window, r[o]), r.splice(o, 1), "create" === i && (e = !0))
            }
        }()
    }
    ...
    function f(t, n, e) {
        ...
        if (a = /\[\]$/, n instanceof Array)
            for (i = 0, r = n.length; i < r; i++) a.test(t) ? e(t, n[i]) : f(t + "[" + ("object" == typeof n[i] ? i : "") + "]", n[i], e);
        else if ("object" == typeof n)
            for (o in n) f(t + "[" + o + "]", n[o], e);
        else e(t, n)
    }
    ...
    function k(t, n, e, o) {
        (n = function(t) {
            ...
            return t
        }(n)).sv = "tap-v3" + (l.hasMethod("3pCookie") ? "-3p" : "");
        var i = t + "?" + s(n),
        ...
        if ("withCredentials" in a) a.open(e, r, !0);
            ...
            var c = function() {};
            (a = new XDomainRequest).onerror = c, a.ontimeout = c, a.onprogress = c, a.onload = function() {
    ...
    function g() {
        C() && !a && (d[v].Click.flushQueue(), d[v].Conversion.flushQueue(), d[v].Customer.flushQueue())
    }

    function b(t) {
        d[v].vid = t.sort()[0], d[v].vids = t, n = !0
    }

    function w() {
        if (d[v].vids) {
            for (var t = [], n = d[v].vids.length - 1; 0 <= n; n--) {
                var e = d[v].vids[n];
