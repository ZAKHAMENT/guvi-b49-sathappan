/*! For license information please see ticket-details.min.js.LICENSE.txt */
"use strict";
(self.webpackChunkweb_plugin = self.webpackChunkweb_plugin || []).push([
    [4661], {
        246: (t, r, e) => {
            e.r(r), e.d(r, {
                fetchTicketDetails: () => l
            });
            var n = e(7754);
            ...
            function i() {
                ...
                var x = Object.getPrototypeOf,
                    L = x && x(x(N([])));
                L && L !== e && n.call(L, u) && (j = L);
                var E = O.prototype = w.prototype = Object.create(j);
                ...
                function P(t, r) {
                    function e(i, a, c, u) {
                        ...
                        if ("throw" !== f.type) {
                            var l = f.arg,
                                s = l.value;
                            return s && "object" == o(s) && n.call(s, "__await") ? r.resolve(s.__await).then((function(t) {
                                e("next", t, c, u)
                            }), (function(t) {
                                e("throw", t, c, u)
                    ...
                    if (r || "" === r) {
                        ...
                        if (!isNaN(r.length)) {
                            var i = -1,
                                a = function e() {
                                    for (; ++i < r.length;)
                                        if (n.call(r, i)) return e.value = r[i], e.done = !1, e;
                ...
                return b.prototype = O, a(E, "constructor", {
                    value: O,
                    configurable: !0
                }), a(O, "constructor", {
                    value: b,
                    configurable: !0
                }), b.displayName = s(O, l, "GeneratorFunction"), r.isGeneratorFunction = function(t) {
                    var r = "function" == typeof t && t.constructor;
                    return !!r && (r === b || "GeneratorFunction" === (r.displayName || r.name))
                }, r.mark = function(t) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(t, O) : (t.__proto__ = O, s(t, l, "GeneratorFunction")), t.prototype = Object.create(E), t
                }, r.awrap = function(t) {
                    return {
                        __await: t
                    }
                }, k(P.prototype), s(P.prototype, f, (function() {
                    return this
                })), r.AsyncIterator = P, r.async = function(t, e, n, o, i) {
                    void 0 === i && (i = Promise);
                    var a = new P(h(t, e, n, o), i);
                    return r.isGeneratorFunction(e) ? a : a.next().then((function(t) {
                        return t.done ? t.value : a.next()
                    }))
                }, k(E), s(E, l, "Generator"), s(E, u, (function() {
                    return this
            ...
            function s() {
                var t;
                return t = i().mark((function t(r) {
                    var e, o, a, u, f, l, s;
                    return i().wrap((function(t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                                return e = r.uid, o = r.ymAuthenticationToken, a = void 0 === o ? void 0 : o, u = r.bot, f = r.source, l = void 0 === f ? "yellowmessenger" : f, s = "".concat(window.ymConfig.host, "/api/plugin/active-ticket-details?uid=").concat(e, "&bot=").concat(u, "&source=").concat(l).concat(a ? "&ymAuthenticationToken=".concat(a) : ""), t.abrupt("return", fetch(s, {
                                    headers: c({
                                        "Content-Type": "application/json",
                                        "x-ym-bot-id": window.ymConfig.trigger || u
                                    ...
                                    return (0, n.vU)("Failed to fetch active ticket details", t), null
                                })));
                            case 3:
                            case "end":
                                return t.stop()
