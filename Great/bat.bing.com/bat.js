function UET(o) {
    ...
    this.checkuetHostdocumentload = function() {
        var n = this.uetInstance,
            t;
        if (n.documentLoaded || !document.body || document.readyState && document.readyState !== "interactive" && document.readyState !== "complete" && document.readyState !== "loaded" || n.deferLoad || (n.dispatchq(!0), n.documentLoaded = !0), n.documentLoaded)
            ...
            else if (!n.uetConfig.tcf.enabled || n.uetConfig.tcf.hasLoaded || n.uetConfig.tcf.timeoutId)
            ...
            } else n.uetConfig.cusig.timeoutId = setTimeout(function() {
                n.checkuetHostdocumentload()
            }, 1e3);
        else n.uetConfig.tcf.timeoutId = setTimeout(function() {
            n.checkuetHostdocumentload()
        }, 500);
        ...
        if (t) {
            ...
            try {
                if (this.uetConfig.tcf.gdprApplies = n.gdprApplies, n.gdprApplies === !0) {
                    ...
                    this.uetConfig.tcf.adStorageAllowed ? this.pageLoadDispatch && this.addMsClkId(this.beaconParams) : (delete this.beaconParams.sid, delete this.beaconParams.vid, delete this.beaconParams.msclkid)
                }
            } catch (r) {}
            this.uetConfig.tcf.hasLoaded || (this.uetConfig.tcf.hasLoaded = !0, clearTimeout(this.uetConfig.tcf.timeoutId), this.uetConfig.tcf.timeoutId = null, this.uetLoaded !== !0 && this.checkuetHostdocumentload())
        }
    };
    this.getClUrl = function(n) {
        return this.uetConfig.tcf.enabled === !0 && this.uetConfig.tcf.hasLoaded === !0 && this.uetConfig.tcf.gdprApplies === !0 && this.uetConfig.tcf.adStorageAllowed !== !0 ? n.replace(this.domain, this.domainCl) : n
    };
    ...
    this.trimTagId = function(o) {
        o.Ver !== 1 && (this.stringExists(o.tagId) && !this.stringExists(o.ti) && (o.ti = o.tagId), this.stringExists(o.ti) && (o.ti = o.ti.replace(/^\s+|\s+$/g, "")))
    };
    ...
    this.loadConfig = function() {
        var u, l, e, i, s, a, f, t, v, b, y, n, p, h, r, k, w, c;
        ...
        this.stringExists(i) && (i.match(/^[0-9]{13}$/) || i.match(/^[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$/)) ? this.setCookie(this.uetConfig.dbgCookie, i, 0, !0, !1, "", this.cookieIdMaxLength) : i = this.getCookie(this.uetConfig.dbgCookie, "", this.cookieIdMaxLength);
        this.stringExists(i) && (this.uetConfig.batDebug = i);
        s = 0;
        o.Ver === 1 && o.advertiserId !== undefined && (s = o.advertiserId);
        this.postURL = e + "//" + this.domain + "/action/" + s;
        this.urlPrefix = this.postURL + "?";
        this.errPrefix = e + "//" + this.domain + "/action-err/" + s + "?";
        ...
        for (f in o) a.hasOwnProperty(f) && (this.beaconParams[f] = a[f] === 1 ? encodeURIComponent(o[f]) : o[f]);
        for (this.beaconParams.mid = this.getUuidV4(!0), t = undefined, v = 0; v < 5; v++)
            if (t = "ueto_" + this.makeRandomStr(10), !window[t]) break;
        this.stringExists(o.ti) && (b = ["56004448", "5798164", "20132024", "4000835", "4074038"], y = window.navigator.userLanguage || window.navigator.language, this.stringExists(y) && y.indexOf("de") === 0 && b.indexOf(o.ti) !== -1 && (this.uetConfig.deBlock = !0, this.uetConfig.cookieAllowed = !1));
        try {
            this.stringExists(t) && !window[t] ? window[t] = this.uetInstance : t = undefined
        } catch (n) {}
        this.stringExists(o.ti) && !this.uetConfig.disableContainer && (n = document.createElement("script"), p = e + "//" + this.domain + "/p/action/" + o.ti + ".js", this.stringExists(this.uetConfig.batDebug) && (p += "?bat_debug=" + this.uetConfig.batDebug), n.src = p, n.type = "text/javascript", n.async = 1, t && n.setAttribute("data-ueto", t), document.head.appendChild(n));
        h = [];
        r = this;
        ...
        h.length > 0 && !!window.Promise && !!window.Promise.allSettled && (this.deferLoad = !0, k = setTimeout(function() {
            r.deferLoad = !1
        }, 50), Promise.allSettled(h).then(function() {
            r.deferLoad = !1;
            clearTimeout(k)
        }));
        this.stringExists(this.uetConfig.batDebug) && window.opener && this.stringExists(o.ti) && (w = "https://ui.ads.microsoft.com", document.referrer && window.URL && (c = new URL(document.referrer), c.protocol === "https:" && /\.microsoft\.com$/.test(c.hostname) && (w = c.origin)), window.opener.postMessage({
            type: "AckBatDbgMode",
            tagId: o.ti
        }, w))
    };
    ...
    this.push = function() {
        ...
        this.uetInstance.uetLoaded || t === "set" || t === "consent" || t === "config" ? this.uetInstance._push([t, i, r]) : this.uetInstance.eventPushQueue.push([t, i, r])
    };
    this._push = function(n) {
        var o, u, s, i, e, r, t, f;
        if (n[1] instanceof Array)
            if (n[0] === "event") {
                if (o = n[1][1] || {}, u = n[1][0], u === null || u === undefined) return;
                s = u === this.pageViewEvt ? this.pageLoadEvt : this.customEvt;
                this.evt(s, u, o, n[2])
            } else if (n[0] === "set") {
            ...
            f === "default" ? (t.hasOwnProperty("ad_storage") && this.uetConfig.consent.adStorageUpdated === !1 && (this.uetConfig.consent.adStorageAllowed = t.ad_storage !== "denied", this.uetConfig.consent.enforced = !1), t.hasOwnProperty("wait_for_update") && (r = parseInt(t.wait_for_update, 10), !isNaN(r) && r > 0 && (r = Math.min(r, 1e4), this.uetConfig.consent.waitForUpdate = r))) : f === "update" && t.hasOwnProperty("ad_storage") && (this.uetConfig.consent.adStorageAllowed = t.ad_storage !== "denied", this.uetConfig.consent.adStorageUpdated = !0, this.uetConfig.consent.enforced = !1, this.uetConfig.consent.adStorageAllowed ? this.pageLoadDispatch && this.addMsClkId(this.beaconParams) : (delete this.beaconParams.sid, delete this.beaconParams.vid, delete this.beaconParams.msclkid))
        } else if (n[0] === "config") {
            if (t = n[1][1], f = n[1][0], t === null || typeof t != "object") return;
            f === "tcf" && t.hasOwnProperty("enabled") && t.enabled === !0 && typeof __tcfapi == "function" && (this.uetConfig.tcf.enabled = !0, window.__tcfapi("addEventListener", 2, this.tcfCallback.bind(this)), this.uetConfig.consent.enforced === !0 && (this.uetConfig.consent.enabled = !1, this.uetConfig.consent.enforced = !1))
        }
    };
    ...
    this.throwError = function(n) {
        if (this.helperError(n), this.uetConfig.errorBeaconLevel > 0) {
            ...
            var t = this.combine(this.beaconParams, {
                ...
                r = this.removeTrailingAmp(this.getClUrl(this.errPrefix) + i);
        ...
        if (r = r !== !1, i = i || {}, this.uetConfig.disableAutoPageView === !0 && this.evqDispatch === !1 && this.dispatchq(!1), typeof i == "object") {
            if (this.uetConfig.allRep === !0 ? i.rep = "1" : i.hasOwnProperty("rep") && (i.rep === 1 || i.rep === "1" || i.rep === !0 ? i.rep = "1" : delete i.rep), this.enforceConsent(), n === this.pageLoadEvt && (this.uetConfig.gtagPid === !0 && "enhanced_conversion_data" in window && typeof enhanced_conversion_data == "object" && (this.pageLevelParams.pid = {
                ...
                if (i.ea != null && this.knownEvents.hasOwnProperty(i.ea)) {
                    p = this.knownEvents[i.ea];
                    for (c in i) p.indexOf(c) === -1 && delete i[c]
                }
                if (l = !r && i.hasOwnProperty("page_path"), l) {
                    if (i.spa = "Y", this.pageLoadDispatch === !1 ? (u = {}, u = this.addPageData(u, !1), this.stringExists(u.p) && (this.previousPage = u.p), i.r = u.r, i.lt = u.lt, u.hasOwnProperty("pt") && (i.pt = u.pt), u.hasOwnProperty("pn") && (i.pn = u.pn)) : (this.firePageHide(), this.midOverride || (this.beaconParams.mid = this.getUuidV4(!0))), i.hasOwnProperty("page_title") && (i.tl = i.page_title, delete i.page_title), this.stringExists(this.previousPage)) {
                        if (a = this.previousPage.toUpperCase(), s = a.indexOf("%3A%2F%2F"), s === -1) return;
                        w = i.page_path.substring(0, 3).toUpperCase() === "%2F";
                        w ? (s += 9, v = a.indexOf("%2F", s), i.p = v === -1 ? this.previousPage + i.page_path : this.previousPage.substring(0, v) + i.page_path) : i.p = this.previousPage
                    }
                } else {
            ...
            this.uetConfig.tcf.enabled === !0 && (o = {
                st: this.uetConfig.tcf.hasLoaded === !0 ? "L" : "E"
            }, this.uetConfig.tcf.gdprApplies === !0 && (o.gdpr = "Y", this.uetConfig.tcf.adStorageAllowed === !0 && (o.as = "G"), this.uetConfig.tcf.measurementAllowed === !0 && (o.ms = "G"), this.uetConfig.tcf.personalizationAllowed === !0 && (o.pz = "G")), i.tcf = encodeURIComponent(this.removeTrailingAmp(this.stringifyToRequest(o))));
        ...
        try {
            ...
            for (n = 0; n < t.length; n++)
                if (window.hasOwnProperty(t[n].f)) {
                    i = n + 1;
                    r = this.stringExists(this.getCookie(t[n].c, "", 4096));
                    break
                }
            return {
                cmp: i,
    ...
    this.enforceConsent = function() {
        var n = this.getCmpData();
        this.uetConfig.consent.enabled !== !0 && this.uetConfig.tcf.enabled !== !0 && (this.uetConfig.cusig.blob.bi === !0 || this.uetConfig.cusig.blob.at === !1 && n.hasCookie === !1 && (this.uetConfig.cusig.blob.co === "de" || this.uetConfig.cusig.blob.co === "nl")) ? (this.uetConfig.consent.enabled = !0, this.uetConfig.consent.adStorageAllowed = !1, this.uetConfig.consent.enforced = !0, delete this.beaconParams.sid, delete this.beaconParams.vid, delete this.beaconParams.msclkid) : n.hasCookie && this.uetConfig.consent.enforced === !0 && (this.uetConfig.consent.enabled = !1, this.uetConfig.consent.enforced = !1)
    };
    ...
    this.setExternalMid = function(n) {
        this.stringExists(n) && n.match(/^[0-9a-fA-F]{8}-?([0-9a-fA-F]{4}-?){3}[0-9a-fA-F]{12}$/) && (this.beaconParams.mid = n, this.midOverride = !0)
    };
