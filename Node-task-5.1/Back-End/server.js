...
const app = express();
app.use(cors({
  origin: 'https://662205023721d683a33dbd1d--effulgent-panda-0eb781.netlify.app', 
...
async function sendEmail(email, token) {
  const resetLink = `https://662205023721d683a33dbd1d--effulgent-panda-0eb781.netlify.app/reset-password/${token}`; 
  const mailOptions = {
