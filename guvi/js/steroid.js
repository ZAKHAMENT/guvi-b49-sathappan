    ...
    loginCheck() {
        ...
        if (authorize.getSession("authToken") == null) {
            ...
            if (page == "landing-page") {
                $(".account-links-group").html('<li class="nav-item"><a class="nav-link text-green" href=' + home + '>My account</a></li><li class="nav-item"><a class="nav-link btn btn-primary text-white" href="javascript:authorize.signout();">Sign out</a></li>');
                ...
                let renderString = '';
                renderString += '  <div class="row d-flex flex-nowrap align-items-center toggle_box"><div class="col-md-3 ml-2"><img src="' + profilepic + '" width="40" height="40" class="rounded-circle d-flex justify-content-center"/></div><div class="d-flex flex-row" id="mainNavDefault" style="line-height: 1em; border-bottom:none; "><p class="experience"><i class="icon-geekoin" aria-hidden="true">Geekoin:</i><span>' + geekoins + '</span></p><p class="rank rank_main_board" style=""><i class="rank_board" aria-hidden="true">Rank:</i><span>' + rank + '</span></p></div><div class="col-md-9 pl-2 usr_name"> <h6>' + name + ' </h6> <small class="text-secondary">' + mail + '</small></div></div><hr /><div class="row"><a class="dropdown-item text-secondary mt-2" href="/' + profile + '">My Profile</a><a class="dropdown-item text-secondary mt-2" href="/change-password/">Change Password</a>'
