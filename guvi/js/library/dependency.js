!function(e, t) {
    ...
    T.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (d(Object(e)) ? T.merge(n, "string" == typeof e ? [e] : e) : l.call(n, e)),
            n
        },
    ...
    var p = function(n) {
        ...
        var e, d, b, o, s, p, h, g, w, l, u, E, C, a, x, m, c, v, y, T = "sizzle" + 1 * new Date, _ = n.document, S = 0, i = 0, A = le(), D = le(), N = le(), I = le(), O = function(e, t) {
            return e === t && (u = !0),
            0
        }, k = {}.hasOwnProperty, t = [], L = t.pop, j = t.push, P = t.push, H = t.slice, q = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, R = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", F = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", W = "\\[" + M + "*(" + F + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + F + "))|)" + M + "*\\]", B = ":(" + F + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)", U = new RegExp(M + "+","g"), $ = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$","g"), K = new RegExp("^" + M + "*," + M + "*"), z = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), Q = new RegExp(M + "|>"), V = new RegExp(B), Y = new RegExp("^" + F + "$"), X = {
            ID: new RegExp("^#(" + F + ")"),
            CLASS: new RegExp("^\\.(" + F + ")"),
            TAG: new RegExp("^(" + F + "|[*])"),
            ATTR: new RegExp("^" + W),
        ...
        }, G = /HTML$/i, J = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, ee = /^[^{]+\{\s*\[native \w/, te = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ne = /[+~]/, ie = new RegExp("\\\\([\\da-f]{1,6}" + M + "?|(" + M + ")|.)","ig"), re = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, oe = function(e, t) {
        ...
        try {
            P.apply(t = H.call(_.childNodes), _.childNodes),
        ...
        function ae(e, t, n, i) {
            ...
            "string" != typeof e || !e || 1 !== h && 9 !== h && 11 !== h)
                return n;
            if (!i && ((t ? t.ownerDocument || t : _) !== C && E(t),
            t = t || C,
            x)) {
                if (11 !== h && (l = te.exec(e)))
                    if (r = l[1]) {
                        ...
                        if ((r = l[3]) && d.getElementsByClassName && t.getElementsByClassName)
                            return P.apply(n, t.getElementsByClassName(r)),
                            n
                    }
                if (d.qsa && !I[e + " "] && (!m || !m.test(e)) && (1 !== h || "object" !== t.nodeName.toLowerCase())) {
                    ...
                    f = t,
                    1 === h && Q.test(e)) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(re, oe) : t.setAttribute("id", a = T),
                        o = (u = p(e)).length; o--; )
                            u[o] = "#" + a + " " + _e(u[o]);
                        c = u.join(","),
                        f = ne.test(e) && ve(t.parentNode) || t
                    }
                    try {
        ...
        E = ae.setDocument = function(e) {
            ...
            x = !s(C),
            _ !== C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", r, !1) : n.attachEvent && n.attachEvent("onunload", r)),
            ...
            : function(e, t) {
                ...
                if (!r || !o)
                    return e === C ? -1 : t === C ? 1 : r ? -1 : o ? 1 : l ? q(l, e) - q(l, t) : 0;
                if (r === o)
                    return he(e, t);
        ...
        ae.matchesSelector = function(e, t) {
            ...
            d.matchesSelector && x && !I[t + " "] && (!c || !c.test(t)) && (!m || !m.test(t)))
                try {
                    var n = v.call(e, t);
        ...
        (b = ae.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return X.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && V.test(n) && (t = p(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(n, i, r) {
                    return function(e) {
                        var t = ae.attr(e, n);
                        return null == t ? "!=" === i : !i || (t += "",
                        "=" === i ? t === r : "!=" === i ? t !== r : "^=" === i ? r && 0 === t.indexOf(r) : "*=" === i ? r && -1 < t.indexOf(r) : "$=" === i ? r && t.slice(-r.length) === r : "~=" === i ? -1 < (" " + t.replace(U, " ") + " ").indexOf(r) : "|=" === i && (t === r || t.slice(0, r.length + 1) === r + "-"))
                    }
                },
                CHILD: function(p, e, t, g, m) {
                    ...
                    : function(e, t, n) {
                        var i, r, o, s, a, l, u = v != y ? "nextSibling" : "previousSibling", c = e.parentNode, f = _ && e.nodeName.toLowerCase(), h = !n && !_, d = !1;
                        if (c) {
                            if (v) {
                                for (; u; ) {
                                    for (s = e; s = s[u]; )
                            ...
                            y && h) {
                                for (d = (a = (i = (r = (o = (s = c)[T] || (s[T] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === S && i[1]) && i[2],
                                s = a && c.childNodes[a]; s = ++a && s && s[u] || (d = a = 0) || l.pop(); )
                                    if (1 === s.nodeType && ++d && s === e) {
                                        r[p] = [S, a, d];
                                        break
                                    }
                            } else if (h && (d = a = (i = (r = (o = (s = e)[T] || (s[T] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === S && i[1]),
                            !1 === d)
                                for (; (s = ++a && s && s[u] || (d = a = 0) || l.pop()) && ((_ ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++d || (h && ((r = (o = s[T] || (s[T] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [S, d]),
                                s !== e)); )
                                    ;
            ...
            pseudos: {
                ...
                lang: ue(function(n) {
                    return Y.test(n || "") || ae.error("unsupported lang: " + n),
        ...
        function be(a, e, t) {
            ...
            : function(e, t, n) {
                ...
                if (n) {
                    ...
                    for (; e = e[l]; )
                        if (1 === e.nodeType || f)
                            if (r = (o = e[T] || (e[T] = {}))[e.uniqueID] || (o[e.uniqueID] = {}),
            ...
            ue(function(e, t, n, i) {
                var r, o, s, a = [], l = [], u = t.length, c = e || function(e, t, n) {
                    for (var i = 0, r = t.length; i < r; i++)
                        ae(e, t[i], n);
                    return n
                }(p || "*", n.nodeType ? [n] : n, []), f = !d || !e && p ? c : Ee(c, a, d, n, i), h = g ? v || (e ? d : u || m) ? [] : t : f;
                if (g && g(f, h, n, i),
                m)
                    for (r = Ee(h, l),
                    m(r, [], n, i),
                ...
                if (e) {
                    if (v || d) {
                        ...
                        for (o = h.length; o--; )
                            (s = h[o]) && -1 < (r = v ? q(e, s) : a[o]) && (e[r] = !(t[r] = s))
                    }
                } else
                    h = Ee(h === t ? h.splice(u, h.length) : h),
                    v ? v(null, t, h, i) : P.apply(t, h)
            })
        }
        function xe(e) {
        ...
        p = ae.tokenize = function(e, t) {
            ...
            a = [],
            l = b.preFilter; s; ) {
                for (o in n && !(i = K.exec(s)) || (i && (s = s.slice(i[0].length) || s),
                a.push(r = [])),
                n = !1,
        ...
        h = ae.compile = function(e, t) {
            var n, m, v, y, _, i, r = [], o = [], s = N[e + " "];
            if (!s) {
                for (n = (t = t || p(e)).length; n--; )
                    (s = xe(t[n]))[T] ? r.push(s) : o.push(s);
                (s = N(e, (m = o,
                y = 0 < (v = r).length,
                _ = 0 < m.length,
                i = function(e, t, n, i, r) {
                    var o, s, a, l = 0, u = "0", c = e && [], f = [], h = w, d = e || _ && b.find.TAG("*", r), p = S += null == h ? 1 : Math.random() || .1, g = d.length;
        ...
        g = ae.select = function(e, t, n, i) {
            ...
            return (u || h(e, c))(i, t, !x, n, !t || ne.test(e) && ve(t.parentNode) || t),
            n
        }
        ,
        d.sortStable = T.split("").sort(O).join("") === T,
    ...
    (T.fn.init = function(e, t, n) {
        ...
        "string" != typeof e)
            ...
            this.length = 1,
            this) : _(e) ? void 0 !== n.ready ? n.ready(e) : e(T) : T.makeArray(e, this);
        if (!(i = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : k.exec(e)) || !i[1] && t)
        ...
        if (i[1]) {
            ...
            N.test(i[1]) && T.isPlainObject(t))
                for (i in t)
                    _(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
            return this
        }
    ...
    T.extend({
                        ...
                        return function() {
                            function e() {
                                ...
                                if (!(r < l)) {
                                    ...
                                    _(t) ? a ? t.call(e, u(l, o, q, a), u(l, o, R, a)) : (l++,
                                    t.call(e, u(l, o, q, a), u(l, o, R, a), u(l, o, q, o.notifyWith))) : (s !== q && (n = void 0,
                                    i = [e]),
                                    (a || o.resolveWith)(n, i))
                                }
                            }
        ...
        when: function(e) {
            ...
            var n = arguments.length
              ...
              , o = a.call(arguments)
              , s = T.Deferred();
            if (n <= 1 && (M(e, s.done(t(i)).resolve, s.reject, !n),
    ...
    T.ready.then = W.then,
    "complete" === x.readyState || "loading" !== x.readyState && !x.documentElement.doScroll ? C.setTimeout(T.ready) : (x.addEventListener("DOMContentLoaded", B),
    ...
    function ue(e, t, n, i) {
        ...
        , l = a(), u = n && n[3] || (T.cssNumber[t] ? "" : "px"), c = e.nodeType && (T.cssNumber[t] || "px" !== u && +l) && ne.exec(T.css(e, t));
        if (c && c[3] !== u) {
            for (l /= 2,
            u = u || c[3],
            c = +l || 1; s--; )
    ...
    (_e = x.createElement("input")).setAttribute("type", "radio"),
    ...
    T.event = {
        ...
        dispatch: function(e) {
            var t, n, i, r, o, s, a = T.event.fix(e), l = new Array(arguments.length), u = (X.get(this, "events") || {})[a.type] || [], c = T.event.special[a.type] || {};
            for (l[0] = a,
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return he.test(t.type) && t.click && D(t, "input") && Ne(t, "click", Te),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return he.test(t.type) && t.click && D(t, "input") && Ne(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    function Re(n, i, r, o) {
        i = m.apply([], i);
        var e, t, s, a, l, u, c = 0, f = n.length, h = f - 1, d = i[0], p = _(d);
        if (p || 1 < f && "string" == typeof d && !y.checkClone && ke.test(d))
        ...
        t || o)) {
            for (a = (s = T.map(me(e, "script"), Pe)).length; c < f; c++)
                l = e,
                c !== h && (l = T.clone(l, !0, !0),
            ...
            if (a)
                ...
                c = 0; c < a; c++)
                    l = s[c],
                    pe.test(l.type || "") && !X.access(l, "globalEval") && T.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && !l.noModule && T._evalUrl(l.src, {
        ...
        clone: function(e, t, n) {
            ...
            if (!(y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || T.isXMLDoc(e)))
                ...
                r = (o = me(e)).length; i < r; i++)
                    a = o[i],
                    "input" === (u = (l = s[i]).nodeName.toLowerCase()) && he.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
            if (t)
                if (n)
                    for (o = o || me(e),
                    s = s || me(c),
    ...
    T.fn.extend({
        ...
        replaceWith: function() {
            ...
            return Re(this, arguments, function(e) {
                ...
                T.inArray(this, n) < 0 && (T.cleanData(me(this)),
    ...
    var Fe, We, Be, Ue, $e, Ke, ze, Qe = new RegExp("^(" + te + ")(?!px)[a-z%]+$","i"), Ve = function(e) {
    ...
    function Xe(e, t, n) {
        ...
        return (n = n || Ve(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || oe(e) || (s = T.style(e, t)),
        !y.pixelBoxStyles() && Qe.test(s) && Ye.test(t) && (i = a.width,
        r = a.minWidth,
        o = a.maxWidth,
    ...
    function Je() {
        if (ze) {
            Ke.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",
            ...
            re.appendChild(Ke).appendChild(ze);
            var e = C.getComputedStyle(ze);
            Fe = "1%" !== e.top,
            $e = 12 === Ze(e.marginLeft),
            ze.style.right = "60%",
            Ue = 36 === Ze(e.right),
            We = 36 === Ze(e.width),
            ze.style.position = "absolute",
            Be = 12 === Ze(ze.offsetWidth / 3),
            re.removeChild(Ke),
            ze = null
        }
    }
    ...
    function ut(e, t, n, i, r, o) {
        ...
        for (; s < 4; s += 2)
            ...
            i ? ("content" === n && (l -= T.css(e, "padding" + ie[s], !0, r)),
            "margin" !== n && (l -= T.css(e, "border" + ie[s] + "Width", !0, r))) : (l += T.css(e, "padding" + ie[s], !0, r),
            "padding" !== n ? l += T.css(e, "border" + ie[s] + "Width", !0, r) : a += T.css(e, "border" + ie[s] + "Width", !0, r));
    ...
    function ct(e, t, n) {
        ...
        return (!y.boxSizingReliable() && r || "auto" === s || !parseFloat(s) && "inline" === T.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === T.css(e, "boxSizing", !1, i),
        (o = a in e) && (s = e[a])),
    ...
    T.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = Q(t), l = ot.test(t), u = e.style;
                if (l || (t = it(a)),
    ...
    T.each(["height", "width"], function(e, l) {
        T.cssHooks[l] = {
            get: function(e, t, n) {
                if (t)
                    return !rt.test(T.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ct(e, l, n) : le(e, st, function() {
                        return ct(e, l, n)
                    })
            },
            set: function(e, t, n) {
                var i, r = Ve(e), o = !y.scrollboxSize() && "absolute" === r.position, s = (o || n) && "border-box" === T.css(e, "boxSizing", !1, r), a = n ? ut(e, l, n, s, r) : 0;
    ...
    T.fx.step = {};
    var ht, dt, pt, gt, mt = /^(?:toggle|show|hide)$/, vt = /queueHooks$/;
    function yt() {
        dt && (!1 === x.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(yt) : C.setTimeout(yt, T.fx.interval),
        T.fx.tick())
    }
    function _t() {
    ...
    function Et(o, e, t) {
        var n, s, i = 0, r = Et.prefilters.length, a = T.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (s)
                return !1;
            for (var e = ht || _t(), t = Math.max(0, u.startTime + u.duration - e), n = 1 - (t / u.duration || 0), i = 0, r = u.tweens.length; i < r; i++)
                u.tweens[i].run(n);
        ...
        for (function(e, t) {
            ...
            if (n = Et.prefilters[i].call(u, o, c, u.opts))
    ...
    T.Animation = T.extend(Et, {
        ...
        tweener: function(e, t) {
            for (var n, i = 0, r = (e = _(e) ? (t = e,
            ["*"]) : e.match(H)).length; i < r; i++)
                n = e[i],
                Et.tweeners[n] = Et.tweeners[n] || [],
                Et.tweeners[n].unshift(t)
        },
        prefilters: [function(e, t, n) {
            var i, r, o, s, a, l, u, c, f = "width"in t || "height"in t, h = this, d = {}, p = e.style, g = e.nodeType && ae(e), m = X.get(e, "fxshow");
    ...
    T.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? T.prop(e, t, n) : (1 === o && T.isXMLDoc(e) || (r = T.attrHooks[t.toLowerCase()] || (T.expr.match.bool.test(t) ? Ct : void 0)),
        ...
        toggleClass: function(r, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(r) : this.removeClass(r) : _(r) ? this.each(function(e) {
                ...
                if (s)
                    ...
                    void 0 !== r && "boolean" != o || ((e = Dt(this)) && X.set(this, "__className__", e),
    ...
    T.extend(T.event, {
        trigger: function(e, t, n, i) {
            var r, o, s, a, l, u, c, f, h = [n || x], d = v.call(e, "type") ? e.type : e, p = v.call(e, "namespace") ? e.namespace.split(".") : [];
            if (o = f = s = n = n || x,
            3 !== n.nodeType && 8 !== n.nodeType && !kt.test(d + T.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(),
            p.sort()),
            l = d.indexOf(":") < 0 && "on" + d,
            ...
            i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!i && !c.noBubble && !g(n)) {
                    ...
                    kt.test(a + d) || (o = o.parentNode); o; o = o.parentNode)
                        h.push(o),
                        s = o;
                ...
                return e.type = d,
                i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(h.pop(), t) || !V(n) || l && _(n[d]) && !g(n) && ((s = n[l]) && (n[l] = null),
                T.event.triggered = d,
    ...
    T.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var c, f, h, n, d, i, p, g, r, o, m = T.ajaxSetup({}, t), v = m.context || m, y = m.context && (v.nodeType || v.jquery) ? T(v) : T.event, _ = T.Deferred(), b = T.Callbacks("once memory"), w = m.statusCode || {}, s = {}, a = {}, l = "canceled", E = {
                readyState: 0,
            ...
            if (_.promise(E),
            m.url = ((e || m.url || Lt.href) + "").replace(zt, Lt.protocol + "//"),
            ...
            null == m.crossDomain) {
                ...
                try {
                    i.href = m.url,
                    i.href = i.href,
                    m.crossDomain = Xt.protocol + "//" + Xt.host != i.protocol + "//" + i.host
                } catch (e) {
                    m.crossDomain = !0
                }
            }
            ...
            f = m.url.replace(Bt, ""),
            m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(Wt, "+")) : (o = m.url.slice(f.length),
            m.data && (m.processData || "string" == typeof m.data) && (f += (Pt.test(f) ? "&" : "?") + m.data,
            delete m.data),
            !1 === m.cache && (f = f.replace(Ut, "$1"),
            o = (Pt.test(f) ? "&" : "?") + "_=" + jt++ + o),
            m.url = f + o),
            m.ifModified && (T.lastModified[f] && E.setRequestHeader("If-Modified-Since", T.lastModified[f]),
            T.etag[f] && E.setRequestHeader("If-None-Match", T.etag[f])),
            (m.data && m.hasContent && !1 !== m.contentType || t.contentType) && E.setRequestHeader("Content-Type", m.contentType),
            E.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Yt + "; q=0.01" : "") : m.accepts["*"]),
            m.headers)
            ...
            function u(e, t, n, i) {
                ...
                r ? (m.ifModified && ((l = E.getResponseHeader("Last-Modified")) && (T.lastModified[f] = l),
                (l = E.getResponseHeader("etag")) && (T.etag[f] = l)),
    ...
    y.createHTMLDocument = ((nn = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    2 === nn.childNodes.length),
    T.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t,
        t = !1),
        t || (y.createHTMLDocument ? ((i = (t = x.implementation.createHTMLDocument("")).createElement("base")).href = x.location.href,
...
function(e, t) {
    ...
    function O(e, n, t) {
        return (void 0 === t ? e : e.slice(0, function(e, t, n) {
            ...
            e.enabled && o(t) && (n.offsets.popper = E(n.offsets.popper),
    ...
    function n() {
        ...
        this.state = function(e, t) {
            return s(e).removeEventListener("resize", t.updateBound),
    ...
    function h(n, i) {
        Object.keys(i).forEach(function(e) {
            var t = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && c(i[e]) && (t = "px"),
            n.style[e] = i[e] + t
        })
    }
    function L(e, t, n) {
            ...
            return e.reduce(function(e, t) {
                ...
                return function(e, t, n, i) {
                    ...
                    if (!s)
                        return e;
                    if (0 !== a.indexOf("%"))
                        return "vh" !== a && "vw" !== a ? s : ("vh" === a ? q(document.documentElement.clientHeight, window.innerHeight || 0) : q(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * s;
                    switch (a) {
                    case "%p":
                        r = n;
                        break;
        ...
        value: function() {
            return function() {
                if (!this.state.isDestroyed) {
                    ...
                    e.offsets.reference = u(this.state, this.popper, this.reference, this.options.positionFixed),
    ...
    function te(e, t) {
        ...
        Object.keys(Q({}, te.Defaults.modifiers, i.modifiers)).forEach(function(e) {
        ...
        modifiers: {
                ...
                fn: function(e, i) {
                    ...
                    var u = i.priority
                      ...
                      , f = {
                        primary: function(e) {
                            var t = c[e];
                            return c[e] < l[e] && !i.escapeWithReference && (t = q(c[e], l[e])),
                            B({}, e, t)
                        },
                        secondary: function(e) {
                            var t = "right" === e ? "left" : "top"
                              , n = c[t];
                            return c[e] > l[e] && !i.escapeWithReference && (n = j(c[t], l[e] - ("right" === e ? c.width : c.height))),
                            B({}, t, n)
                        }
                    };
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    return _ = q(j(s[u] - p, _), 0),
                    e.arrowElement = i,
                    e.offsets.arrow = (B(n = {}, f, H(_)),
                    B(n, h, ""),
                    n),
                    e
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(d, p) {
                    if (e(d.instance.modifiers, "inner"))
                        return d;
                    ...
                    return _.forEach(function(e, t) {
                        ...
                        d.placement = m + (y ? "-" + y : ""),
                        d.offsets.popper = Q({}, d.offsets.popper, N(d.instance.popper, d.offsets.reference, d.placement)),
                        d = O(d.instance.modifiers, d, "flip"))
                    }),
                    d
                },
                behavior: "flip",
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, a, l = void 0 === o ? t.gpuAcceleration : o, u = _(e.instance.popper), c = C(u), f = {
                        position: r.position
                    }, h = function(e, t) {
                        function n(e) {
                            return e
                    ...
                    }(e, window.devicePixelRatio < 2 || !V), d = "bottom" === n ? "top" : "bottom", p = "right" === i ? "left" : "right", g = k("transform");
                    if (a = "bottom" == d ? "HTML" === u.nodeName ? -u.clientHeight + h.bottom : -c.height + h.bottom : h.top,
                    s = "right" == p ? "HTML" === u.nodeName ? -u.clientWidth + h.right : -c.width + h.right : h.left,
                    l && g)
                    ...
                    return e.attributes = Q({}, y, e.attributes),
...
function(e, t) {
    ...
    var n, r = "alert", a = "bs.alert", l = "." + a, u = p.fn[r], c = {
        CLOSE: "close" + l,
        CLOSED: "closed" + l,
    ...
    p(document).on(c.CLICK_DATA_API, '[data-dismiss="alert"]', h._handleDismiss(new h)),
    p.fn[r] = h._jQueryInterface,
    p.fn[r].Constructor = h,
    p.fn[r].noConflict = function() {
        return p.fn[r] = u,
        h._jQueryInterface
    }
    ;
    var m, v = "button", y = "bs.button", _ = "." + y, b = ".data-api", w = p.fn[v], E = "active", C = '[data-toggle^="button"]', x = {
    ...
    p.fn[v] = T._jQueryInterface,
    p.fn[v].Constructor = T,
    p.fn[v].noConflict = function() {
        return p.fn[v] = w,
        T._jQueryInterface
    }
    ;
    var A, D = "carousel", N = "bs.carousel", I = "." + N, O = ".data-api", k = p.fn[D], L = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
        pause: "hover",
    ...
    }, R = "active", M = ".active.carousel-item", F = {
        TOUCH: "touch",
        PEN: "pen"
    ...
    A._addTouchEventListeners = function() {
        ...
        if (this._touchSupported) {
            var t = function(e) {
              ...
              , i = function(e) {
                n._pointerEvent && F[e.originalEvent.pointerType.toUpperCase()] && (n.touchDeltaX = e.originalEvent.clientX - n.touchStartX),
                n._handleSwipe(),
    ...
    A._slide = function(e, t) {
        var n, i, r, o = this, s = this._element.querySelector(M), a = this._getItemIndex(s), l = t || s && this._getItemByDirection(e, s), u = this._getItemIndex(l), c = Boolean(this._interval);
        if (r = e === P ? (n = "carousel-item-left",
        ...
        l && p(l).hasClass(R))
            ...
            if (p(this._element).hasClass("slide")) {
                ...
                p(s).one(g.TRANSITION_END, function() {
                    p(l).removeClass(n + " " + i).addClass(R),
                    p(s).removeClass(R + " " + i + " " + n),
                    o._isSliding = !1,
                    setTimeout(function() {
    ...
    p(document).on(q.CLICK_DATA_API, "[data-slide], [data-slide-to]", W._dataApiClickHandler),
    ...
    p.fn[D] = W._jQueryInterface,
    p.fn[D].Constructor = W,
    p.fn[D].noConflict = function() {
        return p.fn[D] = k,
        W._jQueryInterface
    }
    ;
    var U, $ = "collapse", K = "bs.collapse", z = "." + K, Q = p.fn[$], V = {
        toggle: !0,
        parent: ""
    }, Y = {
        toggle: "boolean",
    ...
    }, G = "show", J = "collapse", Z = "collapsing", ee = "collapsed", te = '[data-toggle="collapse"]', ne = ((U = ie.prototype).toggle = function() {
    ...
    U.show = function() {
        ...
        e && (t = p(e).not(this._selector).data(K)) && t._isTransitioning))) {
            var i = p.Event(X.SHOW);
            if (p(this._element).trigger(i),
            !i.isDefaultPrevented()) {
                e && (ie._jQueryInterface.call(p(e).not(this._selector), "hide"),
                t || p(e).data(K, null));
                var r = this._getDimension();
                p(this._element).removeClass(J).addClass(Z),
                this._element.style[r] = 0,
                this._triggerArray.length && p(this._triggerArray).removeClass(ee).attr("aria-expanded", !0),
                this.setTransitioning(!0);
                var o = "scroll" + (r[0].toUpperCase() + r.slice(1))
                  , s = g.getTransitionDurationFromElement(this._element);
                p(this._element).one(g.TRANSITION_END, function() {
                    p(n._element).removeClass(Z).addClass(J).addClass(G),
                    n._element.style[r] = "",
                    n.setTransitioning(!1),
                    p(n._element).trigger(X.SHOWN)
    ...
    U.hide = function() {
        ...
        if (!this._isTransitioning && p(this._element).hasClass(G)) {
            ...
            !t.isDefaultPrevented()) {
                ...
                p(this._element).addClass(Z).removeClass(J).removeClass(G);
                ...
                p(this._element).one(g.TRANSITION_END, function() {
                    ...
                    p(e._element).removeClass(Z).addClass(J).trigger(X.HIDDEN)
    ...
    U._getConfig = function(e) {
        return (e = s({}, V, e)).toggle = Boolean(e.toggle),
        g.typeCheckConfig($, e, Y),
        e
    }
    ,
    ...
    ;
    var re, oe = "dropdown", se = "bs.dropdown", ae = "." + se, le = ".data-api", ue = p.fn[oe], ce = new RegExp("38|40|27"), fe = {
        HIDE: "hide" + ae,
        HIDDEN: "hidden" + ae,
        SHOW: "show" + ae,
        SHOWN: "shown" + ae,
    ...
    }, he = "disabled", de = "show", pe = "dropdown-menu-right", ge = '[data-toggle="dropdown"]', me = ".dropdown-menu", ve = {
        offset: 0,
        flip: !0,
        ...
        if (!this._element.disabled && !p(this._element).hasClass(he)) {
            ...
            !t) {
                ...
                !i.isDefaultPrevented()) {
                    ...
                    p(this._menu).toggleClass(de),
                    p(e).toggleClass(de).trigger(p.Event(fe.SHOWN, n))
                }
            }
        }
    }
    ...
    re.show = function() {
        if (!(this._element.disabled || p(this._element).hasClass(he) || p(this._menu).hasClass(de))) {
            ...
            p(n).trigger(t),
            t.isDefaultPrevented() || (p(this._menu).toggleClass(de),
            p(n).toggleClass(de).trigger(p.Event(fe.SHOWN, e)))
        }
    }
    ,
    re.hide = function() {
        if (!this._element.disabled && !p(this._element).hasClass(he) && p(this._menu).hasClass(de)) {
            ...
            p(n).trigger(t),
            t.isDefaultPrevented() || (p(this._menu).toggleClass(de),
            p(n).toggleClass(de).trigger(p.Event(fe.HIDDEN, e)))
        }
    }
    ,
    re.dispose = function() {
    ...
    re._getConfig = function(e) {
        return e = s({}, this.constructor.Default, p(this._element).data(), e),
        g.typeCheckConfig(oe, e, this.constructor.DefaultType),
        e
    }
    ,
    ...
    re._getPlacement = function() {
        ...
        p(this._menu).hasClass(pe) && (t = "top-end")) : e.hasClass("dropright") ? t = "right-start" : e.hasClass("dropleft") ? t = "left-start" : p(this._menu).hasClass(pe) && (t = "bottom-end"),
        t
    }
    ,
    ...
    be._jQueryInterface = function(t) {
        return this.each(function() {
            ...
            if (e || (e = new be(this,"object" == typeof t ? t : null),
            p(this).data(se, e)),
            "string" == typeof t) {
                if (void 0 === e[t])
            ...
            for (var t = [].slice.call(document.querySelectorAll(ge)), n = 0, i = t.length; n < i; n++) {
                ...
                o) {
                    ...
                    if (p(r).hasClass(de) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && p.contains(r, e.target))) {
                        ...
                        p(a).removeClass(de),
                        p(r).removeClass(de).trigger(p.Event(fe.HIDDEN, s)))
                    }
                }
            }
    }
    ...
    be._dataApiKeydownHandler = function(e) {
        if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(me).length)) : ce.test(e.which)) && (e.preventDefault(),
        e.stopPropagation(),
        !this.disabled && !p(this).hasClass(he))) {
    ...
    p(document).on(fe.KEYDOWN_DATA_API, ge, _e._dataApiKeydownHandler).on(fe.KEYDOWN_DATA_API, me, _e._dataApiKeydownHandler).on(fe.CLICK_DATA_API + " " + fe.KEYUP_DATA_API, _e._clearMenus).on(fe.CLICK_DATA_API, ge, function(e) {
        e.preventDefault(),
        e.stopPropagation(),
        _e._jQueryInterface.call(p(this), "toggle")
    }).on(fe.CLICK_DATA_API, ".dropdown form", function(e) {
        e.stopPropagation()
    }),
    p.fn[oe] = _e._jQueryInterface,
    p.fn[oe].Constructor = _e,
    p.fn[oe].noConflict = function() {
        return p.fn[oe] = ue,
        _e._jQueryInterface
    }
    ;
    var we, Ee = "modal", Ce = "bs.modal", xe = "." + Ce, Te = p.fn[Ee], Se = {
        backdrop: !0,
        keyboard: !0,
        focus: !0,
        show: !0
    ...
    }, Ne = "modal-open", Ie = "fade", Oe = "show", ke = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", Le = ".sticky-top", je = ((we = Pe.prototype).toggle = function(e) {
    ...
    we.show = function(e) {
        ...
        if (!this._isShown && !this._isTransitioning) {
            ...
            p(this._element).on(De.CLICK_DISMISS, '[data-dismiss="modal"]', function(e) {
                return t.hide(e)
            }),
    ...
    we.hide = function(e) {
        ...
        this._isShown && !this._isTransitioning) {
            ...
            this._isShown && !n.isDefaultPrevented()) {
                ...
                this._setEscapeEvent(),
                this._setResizeEvent(),
                p(document).off(De.FOCUSIN),
                p(this._element).removeClass(Oe),
                p(this._element).off(De.CLICK_DISMISS),
                p(this._dialog).off(De.MOUSEDOWN_DISMISS),
                i) {
    ...
    we._hideModal = function() {
        ...
        this._isTransitioning = !1,
        this._showBackdrop(function() {
            p(document.body).removeClass(Ne),
            e._resetAdjustments(),
            e._resetScrollbar(),
            p(e._element).trigger(De.HIDDEN)
        })
    }
    ,
    ...
    we._showBackdrop = function(e) {
        ...
        if (this._isShown && this._config.backdrop) {
            ...
            p(this._element).on(De.CLICK_DISMISS, function(e) {
                t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === t._config.backdrop ? t._element.focus() : t.hide())
            }),
            n && g.reflow(this._backdrop),
            p(this._backdrop).addClass(Oe),
            !e)
                return;
            if (!n)
                return void e();
    ...
    p.fn[Ee] = je._jQueryInterface,
    p.fn[Ee].Constructor = je,
    p.fn[Ee].noConflict = function() {
        return p.fn[Ee] = Te,
        je._jQueryInterface
    }
    ;
        ...
        for (var n = (new window.DOMParser).parseFromString(e, "text/html"), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll("*")), i = function(e, t) {
            ...
            r.forEach(function(e) {
                !function(e, t) {
                    ...
                    if (-1 !== t.indexOf(n))
                        return -1 === He.indexOf(n) || Boolean(e.nodeValue.match(qe) || e.nodeValue.match(Re));
    ...
    var Fe, We = "tooltip", Be = "bs.tooltip", Ue = "." + Be, $e = p.fn[We], Ke = "bs-tooltip", ze = new RegExp("(^|\\s)" + Ke + "\\S+","g"), Qe = ["sanitize", "whiteList", "sanitizeFn"], Ve = {
        animation: "boolean",
        template: "string",
    ...
    }, Ze = "fade", et = "show", tt = "hover", nt = "focus", it = ((Fe = rt.prototype).enable = function() {
        this._isEnabled = !0
    }
    ,
    Fe.disable = function() {
    ...
    Fe.show = function() {
        ...
        if (this.isWithContent() && this._isEnabled) {
            ...
            this.setContent(),
            this.config.animation && p(r).addClass(Ze);
    ...
    Fe.hide = function(e) {
        ...
        if (p(this.element).trigger(r),
        !r.isDefaultPrevented()) {
            if (p(i).removeClass(et),
    ...
    Fe.setContent = function() {
        ...
        p(e).removeClass(Ze + " " + et)
    }
    ,
    Fe.setElementContent = function(e, t) {
        "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = Me(t, this.config.whiteList, this.config.sanitizeFn)),
    ...
    Fe._enter = function(e, t) {
        ...
        p(t.getTipElement()).hasClass(et) || t._hoverState === Ge ? t._hoverState = Ge : (clearTimeout(t._timeout),
        t._hoverState = Ge,
    ...
    Fe._fixTransition = function() {
        ...
        null === e.getAttribute("x-placement") && (p(e).removeClass(Ze),
    ...
    ;
    var gt, mt = "scrollspy", vt = "bs.scrollspy", yt = "." + vt, _t = p.fn[mt], bt = {
        offset: 10,
        method: "auto",
        target: ""
    }, wt = {
    ...
    }, Ct = "active", xt = ".nav, .list-group", Tt = ".nav-link", St = ".list-group-item", At = "position", Dt = ((gt = Nt.prototype).refresh = function() {
        var t = this
    ...
    gt._getConfig = function(e) {
        ...
        return g.typeCheckConfig(mt, e, wt),
        e
    }
    ,
    ...
    gt._activate = function(t) {
        ...
        n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(Ct),
        n.addClass(Ct)) : (n.addClass(Ct),
        n.parents(xt).prev(Tt + ", " + St).addClass(Ct),
        n.parents(xt).prev(".nav-item").children(Tt).addClass(Ct)),
        p(this._scrollElement).trigger(Et.ACTIVATE, {
            relatedTarget: t
        })
    }
    ,
    ...
    Nt._jQueryInterface = function(t) {
        return this.each(function() {
            ...
            if (e || (e = new Nt(this,"object" == typeof t && t),
            p(this).data(vt, e)),
            "string" == typeof t) {
                if (void 0 === e[t])
                    throw new TypeError('No method named "' + t + '"');
    ...
    function Nt(e, t) {
        ...
        this._config = this._getConfig(t),
        this._selector = this._config.target + " " + Tt + "," + this._config.target + " " + St + "," + this._config.target + " .dropdown-item",
        this._offsets = [],
        this._targets = [],
        this._activeTarget = null,
        this._scrollHeight = 0,
        p(this._scrollElement).on(Et.SCROLL, function(e) {
            return n._process(e)
        }),
        this.refresh(),
        this._process()
    ...
    p.fn[mt] = Dt._jQueryInterface,
    p.fn[mt].Constructor = Dt,
    p.fn[mt].noConflict = function() {
        return p.fn[mt] = _t,
        Dt._jQueryInterface
    }
    ;
    var It, Ot = "bs.tab", kt = "." + Ot, Lt = p.fn.tab, jt = {
        HIDE: "hide" + kt,
        HIDDEN: "hidden" + kt,
        SHOW: "show" + kt,
        SHOWN: "shown" + kt,
        CLICK_DATA_API: "click" + kt + ".data-api"
    }, Pt = "active", Ht = ".active", qt = "> li > .active", Rt = ((It = Mt.prototype).show = function() {
        var n = this;
    ...
    p(document).on(jt.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(e) {
        e.preventDefault(),
        Rt._jQueryInterface.call(p(this), "show")
    }),
    p.fn.tab = Rt._jQueryInterface,
    p.fn.tab.Constructor = Rt,
    p.fn.tab.noConflict = function() {
        return p.fn.tab = Lt,
        Rt._jQueryInterface
    }
    ;
    var Ft, Wt = "toast", Bt = "bs.toast", Ut = "." + Bt, $t = p.fn[Wt], Kt = {
        CLICK_DISMISS: "click.dismiss" + Ut,
        HIDE: "hide" + Ut,
        HIDDEN: "hidden" + Ut,
        SHOW: "show" + Ut,
        SHOWN: "shown" + Ut
    }, zt = "show", Qt = "showing", Vt = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
    }, Yt = {
        ...
        function t() {
            ...
            e._element.classList.add(zt),
            p(e._element).trigger(Kt.SHOWN),
            e._config.autohide && e.hide()
        }
        if (p(this._element).trigger(Kt.SHOW),
    ...
    Ft.hide = function(e) {
        var t = this;
        this._element.classList.contains(zt) && (p(this._element).trigger(Kt.HIDE),
    ...
    Ft.dispose = function() {
        clearTimeout(this._timeout),
        this._timeout = null,
        this._element.classList.contains(zt) && this._element.classList.remove(zt),
        p(this._element).off(Kt.CLICK_DISMISS),
    ...
    Ft._getConfig = function(e) {
        return e = s({}, Yt, p(this._element).data(), "object" == typeof e && e ? e : {}),
        g.typeCheckConfig(Wt, e, this.constructor.DefaultType),
        e
    }
    ,
    ...
    Ft._close = function() {
        function e() {
            ...
            p(t._element).trigger(Kt.HIDDEN)
        }
        var t = this;
        if (this._element.classList.remove(zt),
        this._config.animation) {
            var n = g.getTransitionDurationFromElement(this._element);
    ...
    Gt._jQueryInterface = function(n) {
        return this.each(function() {
            var e = p(this)
              , t = e.data(Bt);
            if (t || (t = new Gt(this,"object" == typeof n && n),
            e.data(Bt, t)),
            "string" == typeof n) {
                if (void 0 === t[n])
                    throw new TypeError('No method named "' + n + '"');
    ...
    p.fn[Wt] = Xt._jQueryInterface,
    p.fn[Wt].Constructor = Xt,
...
, function(e, t) {
    e.exports = function(o) {
        return o.handlers.filterStart = o.handlers.filterStart || [],
        o.handlers.filterComplete = o.handlers.filterComplete || [],
        function(e) {
            if (o.trigger("filterStart"),
            o.i = 1,
            o.reset.filter(),
            void 0 === e)
                o.filtered = !1;
...
, function(e, t, n) {
    ...
    e.exports = function(o, s) {
        ...
        var l = {
            search: function(e, t) {
                for (var n = s.multiSearch ? e.replace(/ +$/, "").split(/ +/) : [e], i = 0, r = o.items.length; i < r; i++)
    ...
    e.exports = function(e, n, t) {
        ...
        i = {
            start: function() {
                ...
                a.utils.extend(a, n),
                a.listContainer = "string" == typeof e ? document.getElementById(e) : e,
                a.listContainer && (a.list = c(a.listContainer, a.listClass, !0),
                a.parse = o(13)(a),
                a.templater = o(16)(a),
                a.search = o(14)(a),
                a.filter = o(9)(a),
        ...
        this.remove = function(e, t, n) {
            for (var i = 0, r = 0, o = a.items.length; r < o; r++)
                a.items[r].values()[e] == t && (a.templater.remove(a.items[r], n),
                a.items.splice(r, 1),
                o--,
                r--,
                i++);
        ...
        ,
        this.clear = function() {
            return a.templater.clear(),
            a.items = [],
            a
        }
        ,
        this.on = function(e, t) {
            return a.handlers[e].push(t),
            a
        }
        ,
        ...
        this.trigger = function(e) {
            for (var t = a.handlers[e].length; t--; )
                a.handlers[e][t](a);
            return a
        }
        ,
        this.reset = {
            filter: function() {
                for (var e = a.items, t = e.length; t--; )
                    e[t].filtered = !1;
                return a
            },
            search: function() {
        ...
        this.update = function() {
            ...
            a.templater.clear();
            for (var n = 0; n < t; n++)
                e[n].matching() && a.matchingItems.length + 1 >= a.i && a.visibleItems.length < a.page ? (e[n].show(),
                a.visibleItems.push(e[n]),
                a.matchingItems.push(e[n])) : (e[n].matching() && a.matchingItems.push(e[n]),
                e[n].hide());
            return a.trigger("updated"),
            a
        }
        ,
        i.start()
    ...
    e.exports = function(d) {
        function n(e, t) {
            ...
            for (var f = 1; f <= s; f++) {
                ...
                h && m(n.elm).add(h),
                g(n.elm, f, o)) : p.dotted(e, f, u, c, a, l, e.size()) && (n = e.add({
                    page: "...",
                    dotted: !0
                })[0],
    ...
    e.exports = function(r) {
        ...
        var o = n(2)(r)
          , s = function(e, t) {
            ...
            r.trigger("parseComplete"))
        };
        return r.handlers.parseComplete = r.handlers.parseComplete || [],
        function() {
            var e = function(e) {
                for (var t = e.childNodes, n = [], i = 0, r = t.length; i < r; i++)
...
, function(e, t) {
    e.exports = function(n) {
        function i(e) {
            return n.trigger("searchStart"),
            a.resetList(),
            a.setSearchString(e),
            a.setOptions(arguments),
            a.setColumns(),
            "" === s ? l.reset() : (n.searched = !0,
            t ? t(s, o) : l.list()),
            n.update(),
        ...
        var r, o, s, t, a = {
            ...
            setOptions: function(e) {
                2 == e.length && e[1]instanceof Array ? o = e[1] : 2 == e.length && "function" == typeof e[1] ? (o = void 0,
                t = e[1]) : 3 == e.length ? (o = e[1],
                t = e[2]) : o = void 0
            },
            setColumns: function() {
            ...
            list: function() {
                for (var e = 0, t = n.items.length; e < t; e++)
                    l.item(n.items[e])
            },
            item: function(e) {
                e.found = !1;
                for (var t = 0, n = o.length; t < n; t++)
                    if (l.values(e.values(), o[t]))
                        return void (e.found = !0)
            },
            values: function(e, t) {
                return !!(e.hasOwnProperty(t) && (r = n.utils.toString(e[t]).toLowerCase(),
                "" !== s && -1 < r.search(s)))
            },
            reset: function() {
                n.reset.search(),
        ...
        return n.handlers.searchStart = n.handlers.searchStart || [],
...
, function(e, t) {
    e.exports = function(o) {
        function e() {
            ...
            e ? (i.valueName = o.utils.getAttribute(e, "data-sort"),
            s.getInSensitive(e, i),
            i.order = s.getOrder(e)) : ((i = arguments[1] || i).valueName = arguments[0],
            i.order = i.order || "asc",
            ...
            : function(e, t) {
                ...
                return n.alphabet = o.alphabet || i.alphabet || void 0,
                !n.alphabet && i.insensitive && (n = o.utils.naturalSort.caseInsensitive),
        ...
        return o.handlers.sortStart = o.handlers.sortStart || [],
        ...
        this.clearSourceItem = function(e, t) {
            for (var n = 0, i = t.length; n < i; n++) {
                ...
                if (t[n].data)
                    ...
                    t[n].attr && t[n].name ? (r = l.utils.getByClass(e, t[n].name, !0)) && r.setAttribute(t[n].attr, "") : (r = l.utils.getByClass(e, t[n], !0)) && (r.innerHTML = "");
                r = void 0
            }
            return e
        }
            ...
            for (var n = {}, i = 0, r = t.length; i < r; i++) {
                ...
                if (t[i].data)
                    for (var s = 0, a = t[i].data.length; s < a; s++)
                        n[t[i].data[s]] = l.utils.getAttribute(e.elm, "data-" + t[i].data[s]);
                else
                    t[i].attr && t[i].name ? (o = l.utils.getByClass(e.elm, t[i].name, !0),
                ...
                var n, i = function(e) {
                    for (var t = 0, n = l.valueNames.length; t < n; t++)
                        if (l.valueNames[t].data) {
                            ...
                            if (l.valueNames[t].attr && l.valueNames[t].name && l.valueNames[t].name == e)
    ...
    function i(e, t) {
        for (var n = (e += "").length, i = (t += "").length, r = 0, o = 0; r < n && o < i; ) {
            ...
            if (d(s)) {
                if (!d(a))
                    return s - a;
                for (var l = r, u = o; 48 === s && ++l < n; )
                    s = e.charCodeAt(l);
                for (; 48 === a && ++u < i; )
                    a = t.charCodeAt(u);
                for (var c = l, f = u; c < n && d(e.charCodeAt(c)); )
                    ++c;
                for (; f < i && d(t.charCodeAt(f)); )
                    ++f;
                var h = c - l - f + u;
                if (h)
                    return h;
                for (; l < c; )
                    if (h = e.charCodeAt(l++) - t.charCodeAt(u++))
                        return h;
                r = c,
                o = f
            } else {
                if (s !== a)
                    return s < g && a < g && -1 !== p[s] && -1 !== p[a] ? p[s] - p[a] : s - a;
                ++r,
                ++o
            }
        }
...
, function(e, t) {
    e.exports = function(e, r, t) {
        ...
        var a = i
          ...
          , u = s
          , c = e.indexOf(r, a);
        -1 != c && (u = Math.min(n(0, c), u),
        -1 != (c = e.lastIndexOf(r, a + r.length)) && (u = Math.min(n(0, c), u)));
        var f = 1 << r.length - 1;
        c = -1;
        for (var h, d, p, g = r.length + e.length, m = 0; m < r.length; m++) {
            ...
            for (var b = y; v <= b; b--) {
                ...
                if (_[b] = 0 === m ? (_[b + 1] << 1 | 1) & w : (_[b + 1] << 1 | 1) & w | (p[b + 1] | p[b]) << 1 | 1 | p[b + 1],
                _[b] & f) {
                    var E = n(m, b - 1);
                    if (E <= u) {
                        if (u = E,
