...
useEffect(() => {
  const fetchData = async () => {
    try {
      const polarResponse = await axios.get('https://task-submission-ftgm.onrender.com/get-polar-chart-data', {
    ...
    try {
      const barResponse = await axios.get('https://task-submission-ftgm.onrender.com/get-bar-chart-data', {
        withCredentials: true,
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
  ...
  fetchData();
    ...
    const fetchBarChartData = async () => {
      try {
        const response = await axios.get('https://task-submission-ftgm.onrender.com/get-bar-chart-data', {
          withCredentials: true,
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${localStorage.getItem('token')}`,
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        const fetchSubmittedTasks = async () => {
          try {
            const response = await axios.get('https://task-submission-ftgm.onrender.com/get-submitted-tasks', {
              withCredentials: true,
              headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token')}`,
     ...
     const submitTask = async (newTask) => {
      try {
        ...
        const response = await axios.post(
          'https://task-submission-ftgm.onrender.com/submit-task',
          newTask,
          {
            withCredentials: true,
            headers: {
