...
{/*  ---------------------------------- Coin conatiner --------------------------------------------- */}
                  {coinIconDisappear && (
                        ...
                        <div className={styles.div2}>
                                <img width="48" height="48" src="https://img.icons8.com/emoji/48/star-emoji.png" alt="icon" className={styles.coinIcon}></img><span className={styles.coinText}>       6900</span>   
                            </div>
                        </div>
                        </div>
                  )}
