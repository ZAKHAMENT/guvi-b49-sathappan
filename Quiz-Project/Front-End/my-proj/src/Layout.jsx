...
const Layout = () => {
  ...
  const hideSidebarRoutes = ["/leaderboard", "/register", "/full-screen-page", "/progress"];
            ...
            <main role="main" className={`${styles.containerFluid}`} id="code-kata-page">
                ...
                <header className={` ${styles.homeHeader} ${styles.row} ${styles.bgWhite}`}>
                    <nav className={`${styles.col} ${styles.navbar} ${styles.navbarExpandMd} ${styles.navbarLight} ${styles.shadowSm} ${styles.guviNavheadFixed} ${styles.containerFluid2}`}>
                        ...
                        <div className={styles.navLeaderBoardContainer}>
                            <div className={styles.leaderboard}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="26px" height="26px" viewBox="0 0 24 24"><path fill="currentColor" d="M4 11v8h4v-8H4Zm6-6v14h4V5h-4Zm6 8v6h4v-6h-4Zm4 8H4q-.825 0-1.413-.588T2 19v-8q0-.825.588-1.413T4 9h4V5q0-.825.588-1.413T10 3h4q.825 0 1.413.588T16 5v6h4q.825 0 1.413.588T22 13v6q0 .825-.588 1.413T20 21Z"/></svg>
                                 <Link className={styles.leaderboard} to="/leaderboard">Leaderboard</Link>

                            </div>
                            <div className={styles.leaderboard}>
<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12h4l3 8l4-16l3 8h4"/></svg>                        <Link className={styles.leaderboard} to="/progress">Your Activity</Link>
...
{/*  ---------------------------------- Coin conatiner --------------------------------------------- */}
                  {coinIconDisappear && (
                        ...
                        <div className={styles.div1}>
                                <img src="/images/coinCoinImage.png" alt="icon" className={styles.coinIcon}></img><span className={styles.coinText}>       {userCredentials.userCoins}</span>    
                        </div>
                    ...
                    <div className={styles.sidebarWrapper}>
                        <div className={`${styles.sidebarContainer} ${isSidebarOpen ? '' : styles.sidebarCollapse}`}>
                            <div id="sidebar" className={`${styles.sidebarSticky} ${styles.shadowSm}`}>
                                <ul className={`${styles.nav} ${styles.flexColumn} ${styles.mainMenu}`}> Category
