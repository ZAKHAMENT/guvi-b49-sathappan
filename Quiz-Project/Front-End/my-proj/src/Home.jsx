...
const Home = () => {
    ...
    useEffect(() => {
        if (isChangePasswordPage) {
            document.body.style.backgroundImage = "url('/images/your-background-image.jpg')";
    ...
    const handleProfileClick = () => {
        ...
        setIsChangePasswordPage(false); // Disable background when viewing profile
    };

    const handleChangePassword = () => {
        setShowProfile(false);
        setShowChangePassword(true); // Show profile content
        setIsChangePasswordPage(true); // Enable background on change password page
    };
